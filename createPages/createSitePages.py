...
ALL_PRODUCTION_BOOKS = 1 or not TEST_MODE # If set to False, only selects one book per version for a faster test build
...
class State:
    ...
    BibleLocations = {
                ...
                # NOTE: Notes are special cases (skipped in many parts of the program)
