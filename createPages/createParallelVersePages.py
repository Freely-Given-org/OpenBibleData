                ...
                for versionAbbreviation in parallelVersions: # our adjusted order
                    ...
                    if versionAbbreviation in state.selectedVersesOnlyVersions: # then thisBible is NOT a Bible object, but a dict
                        ...
                        try:
                            ...
                            if versionAbbreviation == 'OET-RV':
                            ...
                            elif versionAbbreviation in ('Wyc','TNT','Cvdl','Gnva','Bshps','KJB-1769','KJB-1611'):
                                ...
                                # ancientRefsToPrint = ('SA1_12:11','SA1_13:16','SA1_13:19','MRK_4:3','LUK_22:69') # For debugging
                                ...
                                == removeVersePunctuation( cleanedModernisedKJB1769TextHtml ):
                                ...
                                == removeVersePunctuation( cleanedModernisedKJB1769TextHtml ).lower():
...
<br>   ({uhbTranscription.replace('<br>','<br>   ')})'''
                            ...
                            if textHtml:
                                ...
                                and 'SR-GNT' in greekWords and greekWords[versionAbbreviation]!=greekWords['SR-GNT']:
                                    ...
                                    versionNameLink = f'''{'../'*BBBLevel}{versionAbbreviation}/details.htm#Top''' if versionAbbreviation in state.versionsWithoutTheirOwnPages else f'''{'../'*BBBLevel}{versionAbbreviation}/byC/{BBB}_C{adjC}.htm#Top'''
                                    ...
                                    if '<div ' in textHtml: # it might be a book intro or footnotes -- we can't put a <div> INSIDE a <p>, so we append it instead
                                        assert '</div>' in textHtml
                                        vHtml = f'''<p id="{versionAbbreviation}" class="parallelVerse"><span id="C{C}V{V}" class="wrkName"><a id="C{C}" title="View {state.BibleNames['OET']} chapter (side-by-side versions)" href="{'../'*BBBLevel}OET/byC/{BBB}_C{adjC}.htm#Top">OET</a> <small>(<a id="V{V}" title="View {state.BibleNames['OET-RV']} chapter (by itself)" href="{'../'*BBBLevel}OET-RV/byC/{BBB}_C{adjC}.htm#Top">OET-RV</a>)</small></span></p>{textHtml}'''
                                    else: # no <div>s so should be ok to put inside a paragraph
                                        assert '</div>' not in textHtml
                                        vHtml = f'''<p id="{versionAbbreviation}" class="parallelVerse"><span id="C{C}V{V}" class="wrkName"><a id="C{C}" title="View {state.BibleNames['OET']} chapter (side-by-side versions)" href="{'../'*BBBLevel}OET/byC/{BBB}_C{adjC}.htm#Top">OET</a> <small>(<a id="V{V}" title="View {state.BibleNames['OET-RV']} chapter (by itself)" href="{'../'*BBBLevel}OET-RV/byC/{BBB}_C{adjC}.htm#Top">OET-RV</a>)</small></span> {textHtml}</p>'''
                            ...
                            vHtml = f'''<p id="OET-RV" class="parallelVerse"><span id="C{C}V{V}" class="wrkName"><a id="C{C}" title="{state.BibleNames['OET']}" href="{'../'*BBBLevel}OET/byC/{BBB}_C{adjC}.htm#Top">OET</a> <small>(<a id="V{V}" title="View {state.BibleNames['OET-RV']} chapter (by itself)" href="{'../'*BBBLevel}OET-RV/byC/{BBB}_C{adjC}.htm#Top">OET-RV</a>)</small></span> <span class="noVerse"><small>{warningText}</small></span></p>'''
                            # else:
...
ENGLISH_WORD_MAP = ( # Place longer words first,
    ...
    ((' abideth',),' abides'),((' abydinge',),' abiding'), ((' abyde ',),' abide '),
        ...
        (('archaungel',),'archangel'), ((' aryse',),' arise'),(('Aryse ',),'Arise '), (('Arke ',),'Ark '),((' arcke ',' arke '),' ark '), ((' aray ',),' array '), ((' arte ',),' art '),
    ...
    ((' backe ',),' back '), (('baptysed','baptisid'),'baptised'), (('baptisynge','baptisyng'),'baptising'), (('baptisme','baptyme','baptym'),'baptism'), ((' baptyse',),' baptise'),
        ...
        ((' bootys',),' boats'),
            ...
            ((' bowe ',),' bow '),
        ((' braunches',),' branches'),((' braunch',' braunche'),' branch'), ((' brasse ',' bras '),' brass '),
    ...
    (('Cæsar','Cesar'),'Caesar'),
            ...
            (('Captaine','Captayne'),'Captain'),((' captaine',),' captain'), (('captiues',),'captives'),(('captyue',),'captive'),
        ...
        (('cheynes','chaines'),'chains'),
            ...
            ((' cheife ',' chefe '),' chief '), (('chyldren',),'children'),(('childre ',),'children '),(('childre.',),'children.'), (('childe ',),'child '),(('chylde,','childe,'),'child,'),(('chylde.','childe.'),'child.'), (('chymney',),'chimney'),
        ...
        ((' coostis',' coastes'),' coasts'), ((' cootis',' coottes',' coates',' cotes'),' coats'),((' cote,',),' coat,'),
            ...
            ((' cometh',' commeth'),' cometh/comes'),
                ...
                (('companyons',),'companions'), (('companye',),'company'), (('complaynte',),'complaint'),((' complaine,',),' complain,'), (('comprehendiden',),'comprehended'),
            (('conseyue ',),'conceive '), (('concubyne',),'concubine'),
                ...
                (('contynued',),'continued'),(('contynuynge','contynuen'),'continuing'),
    ...
    (('Ech ',),'Each '),((' ech ',),' each '),
            ((' eerli',' earely',' earlie',' erly'),' early'), ((' eares ',' eeris ',' eris '),' ears '),((' eares,',' eeris,'),' ears,'), ((' erthe',' erth',' `erthe'),' earth'),
        ...
        (('Effraym',),'Ephraim'),
        ((' eldere ',),' elder '), (('Elias','Helyas'),'Elias/Elijah'),(('Helie','Elie'),'Elye/Elijah'), ((' ellis ',),' else '),
            ((' els ',),' else '),((' els,',),' else,'),
    ...
    ((' failinge',),' failing'), ((' fayle ',),' fail '), ((' faynte ',' faynt '),' faint '),((' faynt.',),' faint.'), ((' feith',' fayth'),' faith'),
            ((' falle ',),' fall '),
        ...
        ((' fielde',' feeld',' felde'),' field'), ((' feendis',),' fiends'),
            ...
            ((' fyue',' fyve',' fiue'),' five'),
        ((' fledde',),' fled'), ((' flye ',' fleen ',' fle '),' flee '), ((' fleischli ',),' fleshly '),((' flesshe',' fleshe',' fleische',' fleisch'),' flesh'),
            ((' flyght ',),' flight '),
            (('flockis',),'flocks'),
                (('floude,',),'flood,'),
        ...
        ((' foale ',),' foal '),
            ...
            (('foolishnesse','folishnes'),'foolishness'), ((' foote ',' fote '),' foot '), ((' footemen',),' footmen'),
            ...
            ((' fauyt ',),' fought '), ((' foundun ',' founden ',' founde ',' foond ',' foud '),' found '), ((' fowre',' foure',' fower'),' four'),
    ...
    ((' hadden ',' hadde '),' had '),((' hadde;',),' had;'),
            ...
            ((' hardnesse ',' hardnes '),' hardness '), ((' harnesse ',),' harness '), ((' harpe',),' harp'), ((' haruest',' heruest'),' harvest'),
            ((' hath ',),' hath/has '),
            (('Haue ',),'Have '),((' haue ',' han '),' have '),((' haue,',),' have,'),((' haue?',),' have?'), ((' havinge',' hauinge',' hauing',' hauynge',' havynge',' hauyng'),' having'),
        (('Hee ',),'He '),((' hee ',),' he '),
            ((' heades',' heddes',' heedis'),' heads'),((' heade ',),' head '), ((' helide',' heelid'),' healed'), ((' helthe ',),' health '), ((' hearde',' herden',),' heard'),((' herynge',' hearyng',' heryng',' hearinge',' heringe',' hering'),' hearing'),((' heareth',' herith'),' hears'),((' heare',' heere'),' hear'), (('Herken ',),'Hearken '),
    ...
    (('Y ',),'I '),(('Y,',),'I,'),(('Y;',),'I;'),
        ...
        (('enclyned',),'inclined'), (('instrumente',),'instrument'), (('inuention',),'invention'),
        ((' yron',),' iron'),
        (('Yt ',),'It '),((' yt ',),' it '),
    ...
    (('Naomy','Naemi'),'Naomi'),
        ...
        (('Nowe ',),'Now '),((' nowe ',),' now '),
        (('noumbride','numbred','nombred'),'numbered'),(('noumbre','nombre','nomber'),'number'),
    ...
    ((' paynes',),' pains'),((' payne',),' pain'),
            ...
            (('Passeouer','Passouer'),'Passover'),((' passiden',' passide'),' passed'),((' passynge',),' passing'),((' passe ',),' pass '),((' passe,',),' pass,'),((' passe?',),' pass?'),((' passe:',),' pass:'),
        ...
        (('playnely','playnly','plainely'),'plainly'), ((' playne ',' plaine '),' plain '), (('playe ',),'play '),(('plaier',),'player'),
    ...
    (('Rabi',),'Rabbi'), ((' raysed',),' raised'),((' reise',' reyse',' rayse'),' raise'),
        ((' redi ',),' ready '),((' redi,',),' ready,'), ((' realme',' rewme'),' realm'), (('reasonyng','reasoninge'),'reasoning'),
            ...
            ((' reiect',),' reject'), ((' reioyce ',' reioyse '),' rejoice '),((' reioyced',' reioysed'),' rejoiced'),
            ((' religioun',),' religion'),
    ...
    (('Sabbathes',),'Sabbaths'),((' sabatys',),' sabbaths'),(('Sabboth','Saboth'),'Sabbath'),((' sabat',' saboth'),' sabbath'),
            ...
            ((' sauyde',' saued'),' saved'),((' saue ',),' save '),((' sauyng',' sauinge',' sauing',' savinge'),' saving'), ((' sauery',),' savoury'),
        ...
        ((' sealeth',),' sealeth/seals'), (('seesyde ' ,'seeside ',),'seaside '), ((' seete ',' seet ',' seate '),' seat '),((' seate.',),' seat.'),
            ...
            ((' sermoun',),' sermon'),
                (('Serue ',),'Serve '),((' serue ',),' serve '),((' serueden',' seruyden',' serued'),' served'), (('seruauntis','seruauntes','servauntes','seruants','servantes'),'servants'),((' seruaunt',' servaunt',' seruant',' seruaut',' servaut'),' servant'), ((' seruice ',' seruyce '),' service '),
            ((' settide ',' sette '),' set '),
        ...
        ((' schal ',' shal ',),' shall '),((' schalt ',),' shalt '), ((' shappe ',),' shape '),
            ...
            ((' shooes',),' shoes'),((' shue',),' shoe'),((' schoo.',),' shoe.'), ((' shoore',),' shore'), ((' shulders',' schuldris'),' shoulders'), (('shouldest','schulen','schuldist'),'should'),((' schulden ',' schulde ',' shulde ',' shuld ',' shoulde '),' should '), (('shoute ','showte '),'shout '), (('shewyng','shewinge','shewing'),'showing'),(('schewide','schewid','shewed'),'showed'),((' schewe ',' shewe '),' show '),
        ...
        ((' spette ',' spate '),' spat '),
            (('speakynge','spekynge','speakinge','spekinge','speakyng'),'speaking'),(('spekith ','speaketh '),'speaketh/speaks '),((' speake',),' speak'), ((' speares',),' spears'),((' spere',),' spear'),
        ...
        ((' staffe ',),' staff '), (('stondinge','standyng','stodinge'),'standing'),((' stondith',),' standeth/stands'),((' stande ',' stonde '),' stand '),((' stonde.',),' stand.'), ((' starre',),' star'),  (('staciouns',),'stations'),
            ((' steale.',),' steal.'), ((' stele ',),' steel '), (('Steppe ',),'Step '),
            ...
            ((' stockis',),' stocks'),
                ...
                ((' storme,',),' storm,'),
            (('strayght','streyght'),'straight'), (('straunger',),'stranger'),(('straunge ',),'strange '), (('stranglide',),'strangled'),
                ...
                ((' stronge ',),' strong '),
            (('stubborne',),'stubborn'), (('stumbleth','stombleth','stomblith'),'stumbles'), ((' stumpe ',),' stump '),
        ...
        (('swete ',),'sweet '), (('sworde','swerde'),'sword'),
        (('synagoge',),'synagogue'),
    (('tabernaclis',),'tabernacles/tents'),
        ...
        (('thankes','thakes'),'thanks'),(('thanke ',),'thank '), (('Thilke ',),'That '),((' thilke ',),' that '),
            ((' thee ',),' thee/you '),((' thee,',),' thee/you,'),((' thee.',),' thee/you.'),
                ((' theyr ',),' their '),
    ...
    ((' wayte ',' waite '),' wait '),((' waite,',),' wait,'),
        ...
        ((' wee ',),' we '),((' wee?',),' we?'),
            ((' wapen ',),' weapon '), ((' weryed',' weried'),' wearied'),((' weery',' wery'),' weary'),
...
GERMAN_WORD_MAP = (
    ('Aber ','But '),(' aber ',' but '),(' abermal:',' again:'),
        (' alle ',' all '),(' alle,',' all,'), (' allein ',' alone '),(' allein.',' alone.'), (' allem ',' everything '), (' allen ',' all '),(' alles ',' all/everything '), ('allmächtige','almighty'),
            ('Also ','So '),
    ...
    (' bald ',' soon '),
        ...
        (' bleibe ',' stay '),(' bleiben ',' remain '), ('Blöken','bleat'), ('Blut','blood'),
    ...
    ('Da ','So '),(' da ',' there '),
            ...
            ('Daß ','That '),(' daß ',' that '),
            (' dazu ',' in_addition '),
        (' dein ',' your '),(' deine ',' your '),(' deinem',' your'),
            (' dem ',' to_him '),(' dem,',' to_him,'),
            (' den ',' the '), ('Denen','Those'), ('Denn ','Because '),(' denn ',' because '), (' denselben ',' the_same '),
            ('Der ','The '),(' der ',' the/of_the '),
            (' des ',' the '),
        (' dich ',' you/yourself '),
            ('Die ','The '),(' die ',' the '), (' dieneten',' served'), ('Dienst','service'), ('Dies ','This/These '),(' dies ',' this/these '), ('Diese ','This/These '),(' diese ',' this/these '),(' diese:',' this/these:'), (' diesem ',' this_one '),
    ...
    (' ehe ',' before '), (' ehernen ',' brazen '),
        ...
        ('Er ','He '),(' er ',' he '),
            ...
            (' erzählten',' told'),
        ('Es ','It '),(' es ',' it '), (' essen',' eat'),(' esse',' eat'),
        (' etliche ',' several '),
            (' etwa ',' approximately '),
        (' euch',' you'),
    ...
    (' gab ',' gave '),(' gab,',' gave,'),(' gaben ',' gave '), ('Gajus','Gaius'), (' ganzen ',' entire '), (' gar ',' even '),
        (' geben ',' give '),(' geben.',' give.'),(' gebe ',' give '), (' gebeten',' requested'),
            ...
            (' gesagt',' said'), (' gesandt',' sent'),
                ('geschrieben','written'),\
                ('Gesellen','fellows'), ('Gesetz','law'),(' gesetz',' set'),
                (' gesund ',' healed '),
            (' getan ',' did '), ('Getreide ','grain '),
            (' gewesen ',' been '),
    ...
    ('Habe ','goods '), (' habe ',' have '),(' habe,',' have,'),(' habe.',' have.'),(' habe;',' have;'), ('haben','have'), (' habt',' have'),
        ...
        (' hebräisch ',' hebrew '),
            ...
            (' herab ',' down '),
                ...
                ('HErr','LORD'),('Herr','Lord'), (' hervor',' out'), ('Herz','heart'),
        (' hie ',' here '), (' hieß ',' was_called '),(' hieß.',' was_called.'), (' hießet ',' is_called '),
            ('Himmel','heaven'),
            (' hin ',' there '),(' hin,',' there,'), (' hinab ',' down '), (' hinauf ',' up '),(' hinauf.',' up.'), (' hinaufzog',' pulled_up'), (' hinter ',' behind '),
        (' holen',' fetch'), ('Hölle','hell'),
            (' höreten',' heard'),(' hörete',' heard'),(' höre',' listen'),
        ('Hügel ','hill '), (' hundert ',' hundred '), ('Hütte ','hut/cabin '),
    ('Ich ','I '),(' ich ',' I '),(' ich,',' I,'),
        (' ihm ',' him '),(' ihm,',' him,'),(' ihm.',' him.'),(' ihm:',' him:'),(' ihm!',' him!'), (' ihn ',' him/it '),(' ihn,',' him/it,'), (' ihnen ',' to_them '),(' ihnen:',' to_them:'), (' ihr ',' you/their/her '), (' ihre ',' their/her '), (' ihrem ',' their '), (' ihren ',' your '), (' ihrer ',' of_their/her '),
    ...
    (' kam ',' came '),(' kam,',' came,'), (' kamen ',' came '), (' kaufen ',' buy '),
        (' keine ',' no '), (' keinen ',' none '),(' keines ',' none '),
        ('Kinder ','children '),('Kinder,','children,'),('Kinder.','children.'),
        ('Kleider ','clothes '),('Kleid ','garment '),
        ('Knechten','servants'),('Knechte','servants'),
        ('Komm ','Come '),(' komme ',' come '),(' kommen ',' coming '),(' kommen,',' coming,'),(' kommt ',' comes '),
        (' konnten ',' could '),
        ('Könige','kings/king'),('Königs','kings'),('König','king'),
        ('Kranken ','sick_ones '), ('Krone ','crown '),
    ('Lade ','box/chest '), ('Lager ','camp '), (' lagerten',' stored'),
    ...
    (' nachdem ',' after '),('Nach ','After '),(' nach ',' after '),(' nach.',' after.'),(' nach!',' after!'), ('Nacht ','night '),
        ...
        (' neben ',' next_to '),
            ...
            ('Nest ','nest '),
            (' neun ',' nine '),
        (' nichts',' nothing'),(' nicht ',' not '),(' nicht,',' not,'),(' nicht;',' not;'),
            (' niemand',' no_one'),
    ...
    ('Sache ','matter '),
        (' sagen',' say'),(' sagte',' said'),(' sagt',' says'),(' sage ',' said '),
            ...
            (' saß ',' sat '),
        ('Schafe,','sheep,'), ('Schande ','shame '),
                (' schied ',' separated '), ('Schild ','shield/sign '), ('Schiff','ship'),
                (' schlage ',' hit/beat '), (' schlugen ',' hit/beat '),(' schlug ',' hit/beat '),
                ('Schlüssel ','key '),
                (' schrieen ',' screamed '),
        ...
        ('Sohn','son'),('Söhne','sons'),
            (' solch ',' such '),(' solches ',' such '), (' soll ',' should '),(' sollst ',' should '),
        ...
        ('Städte ','cities '),('Städten ','cities '), ('Stadt ','city '),('Stadt,','city,'),('Stadt!','city!'),
                ...
                (' starb ',' died '), ('Starken ','strong_ones '),
                ('Staube ','dust '),('Staub ','dust '),
            (' stehet',' stands'),
                (' steigen',' climb'),
                (' sterben',' die'),(' sterbe',' die'),
            (' stille ',' silence '), ('Stimme ','voice '),
            ('Streit','battle'),('streite ','argue/battle '),('streiten','argue/battle'), ('stritt ','argued/fought '),
            (' stund ',' stood '),
            ('Sünder ','sinners '),
    ('Tage ','days '), (' täglich',' daily'), (' tat ',' did '),(' taten ',' did '),
    ...
    ('Wahrheit','truth'),
        ...
        ('Weg ','path '),
            ...
            (' weinet?',' cries?'),(' weinete ',' cried '), (' weiße ',' white '),
...
LATIN_WORD_MAP = (
    ...
    (' a ',' from '),
        ...
        ('Audita ','Hearing '),(' audi ',' listen '),(' audio',' I_hear'), (' audientes ',' hearing '), (' auribus ',' in_the_ears '), (' autem',' however'),
        (' bis ',' twice '),
    (' bibere ',' to_drink '),
    ...
    (' faciam ',' I_will_do '),(' faciat ',' let_him_do '), (' faciem ',' face '), (' facite ',' do_it '), (' facta ',' facts '), ('facultatibus','resources'),
        (' fecit ',' he_did '), (' feri ',' wild '),
        ('Fiat ','Let_it_happen '),
            (' fidei',' of_faith'),(' fidem ',' faith '),
            (' fieri ',' to_be_done '),
            (' filia',' daughter'),('Filiæ','Daughters'),('Filii','Children'),(' filii',' children'),('filiorum','of_children'),('Filium','Son'),('Filius','Son'),('Fili,','Son,'),
            (' finibus ',' borders '),
        ('fluctus ','wave '),
    ...
    (' habeat ',' have '),(' habebat ',' had '),(' habes,',' you_have,'), ('habitare','to_live'),
        ...
        (' humeros ',' shoulders '), (' hunc ',' this_one '),
    ('Ibi ','There '),(' ibi ',' there '),
        ('Id ','That '),
    ...
    (' maculæ',' spots'),
        ...
        (' mea.',' my.'), (' meæ ',' my '),
            (' mecum ',' with_me '),
            (' medio ',' in_the_middle '),
            (' mei ',' my/mine '),(' mei.',' my/mine.'),(' meis,',' mine,'),
            (' membra ',' members '),
            (' Men ',' members '),
    ...
    (' ocreas ',' boots '),
        (' oleum ',' oil '),
        ('Omnes ','All_of_them '),(' omnes ',' everyone '), (' omni ',' all '), ('Omnia ','Everything '),(' omnia ',' everything '),(' omnia,',' everything,'), (' omnis ',' everyone '), (' omnipotens',' omnipotent'),
    ...
    (' qua ',' which '),(' quæ ',' which '),(' quambis ',' with_which '),
            ...
            (' quatuor',' four'),
        (' quem ',' which '),
        ('Qui ','Who '),('>qui ','>who '),(' qui ',' who '), ('quia ','because '), ('Quibus ','To_whom '),('quibus ','to_whom '), ('Quis ','Who '),('quis ','who/any '),
    ...
    ('Væ ','Alas '),
        (' vel ',' or '),
            ...
            (' verba ',' words '), ('veritatem','words'), ('vero,','indeed/yet,'),
        ...
        (' vobis ',' to_you '), ('vobiscum','with_you'),
            ('vocans ','calling '), ('vocatur ','is_called '), ('vocavit','he_called'), (' voces',' voices'),
            (' vos ',' you '),
