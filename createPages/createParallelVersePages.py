...
ENGLISH_WORD_MAP = ( # Place longer words first,
    ...
    ((' hadden ',' hadde '),' had '),((' hadde;',),' had;'),
            ...
            ((' handes',' hondes',' hoondis',' hondis'),' hands'),((' hande ',' honde ',' hoond ',' hond '),' hand '),((' hond,',),' hand,'),
...
GERMAN_WORD_MAP = (
    ...
    ('Da ','So '),(' da ',' there '),
        ...
        (' dein ',' your '),
            ...
            (' den ',' the '), ('Denen','Those'), ('Denn ','Because '),(' denn ',' because '),
            ('Der ','The '),(' der ',' the '),
            (' des ',' the '),
        (' dich ',' you/yourself '),
    ...
    ('Lande','land'), (' länger ',' longer '),
        ...
        ('Licht','light'),
            ...
            ('Lippen ','lips '),
    (' machen ',' make '),(' machten',' make'), (' mag ',' like '), ('Männer ','men '), ('Manne ','man '), ('Mann ','man '),('Mann.','man.'), ('Märkte ','marketplaces '),
        (' mecum ',' with_me '),
    ...
    (' sagen',' say'), (' sagt',' says'),
        ...
        (' sich ',' itself/yourself/themselves '),(' sich.',' itself/yourself/themselves.'),
            ('Sie ','They/She '),(' sie ',' they/she/them '), (' sieben ',' seven '),
            (' sind ',' are '),
            (' sitzen',' sit'),(' sitzt',' sits'),
        ('Sohn','son'),
            (' solch ',' such '), (' soll ',' should '),
...
LATIN_WORD_MAP = (
    ...
    (' maculæ',' spots'), (' magnus',' big'), (' manu ',' by_hand '),
        (' mea.',' my.'), (' meæ ',' my '), (' mei ',' my/mine '),(' mei.',' my/mine.'), (' mercede ',' reward '), (' meum ',' mine '),(' meum,',' mine,'),(' meum.',' mine.'), (' meus ',' mine '),(' meus,',' mine,'),
    ...
    (' salvabit',' will_save'),
        (' secundum ',' after/second '),
            ...
            (' servata ',' saved '),
        (' si ',' when/but_if '), ('Sic ','So '),(' sic ',' so '), (' sidera ',' stars '), (' sine ',' without '), (' sit,',' let_it_be,'),
        (' stella ',' star '),
        (' suam ',' his_own '),(' suam,',' his_own,'), (' suas ',' their_own '),(' suis',' to_his_own'),(' sum ',' I_am '), (' sunt ',' are '),(' sunt,',' are,'), (' suo ',' his_own '), (' suum ',' his_own '),
    (' te,',' you(sg),'),(' te.',' you(sg).'),
    ...
    ('Væ ','Alas '),
        ...
        (' via ',' road '),
            ...
            (' vir ',' man '), (' viro ',' to_the_man '), (' viros ',' men '),
            (' vis ',' you_want '),
            (' vitæ ',' of_life '), (' vitam ',' life '),
            (' vivat',' he_lives'),
        (' vobis ',' to_you '), ('vobiscum','with_you'), ('vocatur ','is_called '), (' voces',' voices'),
    )
