...
LAST_MODIFIED_DATE = '2024-09-01' # by RJH
...
ENGLISH_WORD_MAP = ( # Place longer words first,
    ...
    (('Gayus',),'Gaius'), (('Galile ',),'Galilee '),(('Galile,',),'Galilee,'),(('Galile.',),'Galilee.'), ((' galoun',),' gallon'),
        ...
        ((' goddes',' goddis'),' gods'),
            (('Goo ','Goe '),'Go '),(('Goo,','Goe,'),'Go,'),((' goe ',' goo '),' go '),((' goe,',),' go,'),((' goe.',' goo.'),' go.'),((' goe:',),' go:'),
    ...
    ((' hadden ',' hadde '),' had '),((' hadde;',),' had;'),
            ...
            ((' hardnesse ',' hardnes '),' hardness '), (('Herken ',),'Hearken '), ((' haruest',' heruest'),' harvest'),
            ((' hath ',),' hath/has '),
            (('Haue ',),'Have '),((' haue ',' han '),' have '),((' haue?',),' have?'), ((' havinge',' hauinge',' hauing',' hauynge',' havynge',' hauyng'),' having'),
        ((' hee ',),' he '),
            ((' heades',' heddes',' heedis'),' heads'),((' heade ',),' head '), ((' helide',' heelid'),' healed'), ((' helthe ',),' health '), ((' hearde',' herden',' herde',' herd'),' heard'),((' herynge',' hearyng',' heryng',' hearinge',' heringe',' hering'),' hearing'),((' heareth',' herith'),' hears'),((' heare',' heere'),' hear'),
...
GERMAN_WORD_MAP = (
    ('Aber ','But '),(' aber ',' but '),(' abermal:',' again:'),
        (' alle ',' all '),(' alle,',' all,'), (' allein ',' alone '),(' allein.',' alone.'), (' allen ',' all '),(' alles ',' all/everything '), ('allmächtige','almighty'),
            ('Also ','So '),
    ...
    ('Habe ','goods '), (' habe ',' have '),(' habe,',' have,'),(' habe.',' have.'),(' habe;',' have;'), ('haben','have'), (' habt',' have'),
        ...
        (' hebräisch ',' hebrew '),
            ...
            (' herab ',' down '),
                ...
                ('HErr','LORD'), (' hervor',' out'), ('Herz','heart'),
        (' hie ',' here '), (' hieß ',' was_called '),(' hieß.',' was_called.'), (' hießet ',' is_called '),
            ('Himmel','heaven'),
            (' hin ',' there '),(' hin,',' there,'), (' hinab ',' down '), (' hinauf ',' up '),(' hinauf.',' up.'), (' hinaufzog',' pulled_up'),
        ('Hölle','hell'),
            (' hörete',' heard'),(' höre',' listen'),
        (' hundert ',' hundred '), ('Hütte ','hut/cabin '),
    ('Ich ','I '),(' ich ',' I '),(' ich,',' I,'),
        (' ihm ',' him '),(' ihm.',' him.'),(' ihm:',' him:'),(' ihm!',' him!'), (' ihn ',' him/it '),(' ihn,',' him/it,'), (' ihnen ',' to_them '), (' ihr ',' her '), (' ihre ',' their/her '), (' ihrem ',' their '), (' ihren ',' your '), (' ihrer ',' of_their/her '),
