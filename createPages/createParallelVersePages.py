...
ENGLISH_WORD_MAP = ( # Place longer words first,
    ...
    (('Sabbathes',),'Sabbaths'),((' sabatys',),' sabbaths'),(('Sabboth','Saboth'),'Sabbath'),((' sabat',' saboth'),' sabbath'),
        ...
        ((' sealeth',),' sealeth/seals'), (('seesyde ' ,'seeside ',),'seaside '), ((' seete ',' seet ',' seate '),' seat '),((' seate.',),' seat.'),
            ...
            ((' sermoun',),' sermon'),
                (('Serue ',),'Serve '),((' serue ',),' serve '),((' serueden',' serued'),' served'), (('seruauntis','seruauntes','servauntes','seruants','servantes'),'servants'),((' seruaunt',' servaunt',' seruant',' seruaut',' servaut'),' servant'), ((' seruice ',' seruyce '),' service '),
            ((' settide ',' sette '),' set '),
