...
ENGLISH_WORD_MAP = ( # Place longer words first,
    ...
    ((' failinge',),' failing'), ((' fayle ',),' fail '), ((' faynte ',' faynt '),' faint '), ((' feith',' fayth'),' faith'),
        ...
        ((' fielde',' feeld',' felde'),' field'), ((' feendis',),' fiends'),
            ...
            ((' fyll ',),' fill '), (('fylthynesse','filthynes'),'filthiness'),
    ...
    ((' hadden ',' hadde '),' had '),((' hadde;',),' had;'), ((' heeris',),' hairs'),
        ...
        ((' holde ',),' hold '), ((' holynesse',' holynes'),' holiness'),((' holines ',),' holiness '),((' hooli ',' holie '),' holy '),((' hooli.',' holie.'),' holy.'),
            ...
            ((' houres',),' hours'),((' houre ',),' hour '), ((' housse ',' hous ',' hows '),' house '),((' housse',),' house'),((' hous,',),' house,'), (('houssholde','housholde'),'household'),
    ...
    (('Rabi',),'Rabbi'), ((' raysed',),' raised'),((' reise',' reyse',' rayse'),' raise'),
        ((' redi ',),' ready '), ((' realme',' rewme'),' realm'), (('reasonyng','reasoninge'),'reasoning'),
            ...
            (('remayned',),'remained'),(('remaynynge','remayninge','remayning'),'remaining'),(('remayne',),'remain'),
    ...
    (('Sabbathes',),'Sabbaths'),((' sabatys',),' sabbaths'),(('Sabboth','Saboth'),'Sabbath'),((' sabat',' saboth'),' sabbath'),
        ...
        (('seesyde ' ,'seeside ',),'seaside '), ((' seete ',' seet ',' seate '),' seat '),
            ...
            ((' sermoun',),' sermon'), (('Serue ',),'Serve '),((' serue ',),' serve '), (('seruauntis','seruauntes','servauntes','seruants','servantes'),'servants'),((' seruaunt',' servaunt',' seruant',' seruaut',' servaut'),' servant'),
            ((' sette ',),' set '),
...
GERMAN_WORD_MAP = (
    ('Aber','But'),(' aber',' but'),
        ...
        (' an ',' at '), (' andern ',' change '), ('Anfang','beginning'),
        (' Arche ',' ark '),
    ...
    ('Da ','So '),(' da ',' there '),
            ...
            ('Darum','Therefore'),
            (' das ',' the '), ('daselbst','there'),
            (' daß ',' that '),
            (' dazu ',' in_addition '),
        (' dein ',' your '),
            (' dem ',' to_him '),(' dem,',' to_him,'),
            (' den ',' the '), ('Denen','Those'), ('Denn ','Because '),
            ('Der ','The '),(' der ',' the '),
            (' des ',' the '),
        (' dich ',' you/yourself '),
            (' die ',' the '), ('Dies ','This/These '), ('Diese ','This/These '), (' diesem ',' this_one '),
            (' dir ',' you '),
    ...
    (' ehe ',' before '),
        ...
        (' ein ',' a '),(' eine ',' one '),(' einen ',' a '),(' einer,',' one,'), ('eingeborenen','native_born'),
        (' er ',' he '), (' erschien',' appeared'),
    ...
    ('Lande','land'),
        ...
        ('Licht','light'),
            ...
            ('Lippen ','lips '),
    (' machten',' make'), ('Männer ','men '), ('Manne ','man '), ('Mann ','man '),('Mann.','man.'), ('Märkte ','marketplaces '),
        (' mecum ',' with_me '),
            ('Meeres','sea'),('Meer ','sea '),('Meer.','sea.'),
            ('Meinest ','Mine '),('Meine ','My '),(' meinem ',' my '),(' meinen ',' my '),(' meine ',' my '),(' mein ',' my '),
            ('Mensch ','person '),
        (' mich ',' me '),
            (' mir ',' to_me '),
            (' mit ',' with '),
    ...
    ('Wahrheit','truth'),
        ...
        (' wie ',' like '), (' wieder',' again'), ('Wind ','wind '),
            (' wird ',' becomes '),
...
LATIN_WORD_MAP = (
    ...
    (' faciat ',' let_him_do '), (' facta ',' facts '), ('facultatibus','resources'),
        (' feri ',' wild '),
        ('Fiat ','Let_it_happen '), (' filia',' daughter'),(' filii',' children'),('Filium','Son'),
        ('fluctus ','wave '),
        ('fratrem','brother'),
