...
ENGLISH_WORD_MAP = ( # Place longer words first,
    ...
    ((' keperis',),' keepers'),((' keepeth ',' kepith ',' kepeth '),' keepeth/keeps '),((' keepe ',' kepe '),' keep '),
        ...
        ((' killiden',' kylled',' kyllid'),' killed'),((' kyll ',),' kill '),((' kyll.',),' kill.'),
            ((' kinrede',),' kindred'), ((' kyndes',' kindes'),' kinds'),((' kynde',),' kind'), (('kingdome','kyngdoom','kyngdome','kyngdom'),'kingdom'), ((' kynges',' kyngis',' kinges'),' kings'),((' kynge ',' kyng '),' king '),((' kynge,',' kyng,'),' king,'),((' kynge.',' kyng.'),' king.'), ((' kynysman',' kynesman',' kynsman'),' kinsman'),((' kynnysmen',),' kinsmen'), ((' kynne',),' kin'),((' kyn,',),' kin,'),
            ((' kiste ',' kyssed '),' kissed '),
