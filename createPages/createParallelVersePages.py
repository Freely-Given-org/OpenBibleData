...
GERMAN_WORD_MAP = (
    ...
    (' gab ',' gave '),(' gab,',' gave,'), ('Gajus','Gaius'), (' gar ',' even '),
...
LATIN_WORD_MAP = (
    ...
    ('dæmonia','demons'), (' daret ',' would_give '),(' daretur',' would_be_given'),
        (' de ',' about '),
            ...
            ('Deum','God'),('Deus','God'),
        ('dicentes','saying'), (' dices:',' you_say:'), (' dicit:',' he_says:'), ('dicitur','it_is_said'),
    ...
    (' faciat ',' let_him_do '), (' faciem ',' face '), (' facite ',' do_it '), (' facta ',' facts '), ('facultatibus','resources'),
        ...
        ('fluctus ','wave '),
        ('fratrem','brother'),('fratrum','brothers'),
        (' fuerit',' has_been'),
    ...
    ('Nati ','born '), (' navi:',' by_ship:'),
        ...
        (' nobis ',' us '),
            ...
            (' nos ',' we '),(' nos,',' we,'), (' nostri ',' our '), ('nostrorum','of_ours'),
            (' novam',' new'),(' novum ',' new '),
        (' nubes ',' clouds '),
            (' nunc ',' now '),
    (' oleum ',' oil '),
