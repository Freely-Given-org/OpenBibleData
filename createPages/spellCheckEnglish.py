                ...
                vPrint( 'Normal' if word.upper()==word
                       or word in ( #  \d{1,3}\), \(
                                ...
                                'believese','servicee','officialsn','daywerk','almightyr','troff','pointse','upsteigen','beetwillen',
                                    ...
                                    'liftet','leavene','interestgroschen','paide','hightime','deceptivee','fewm','vomitedn','pottersacker','pointse',
                                    'giftedn','steern',
                                ...
                                'salva','salvat','salvati','sanctifi','sanctificati',
                                    ...
                                    'si','sit','sol','soli','solem','stat','statu', 'subjecti','summo','superstitio',
                                ...
                                'l','nos','ut','didrachmas','cypri','dona','befores','believess','descendentes','whichro','plebi',
                                'chosenon','yewels','blasphemare',
                                    ...
                                    'occasio','resttionum','namedm','beforeparavi','outnde','asksur','saddensi','rightsverit',
                                    'constitutione','successoribus','transactis','devilsca',
                                    'sepelire','signi',
