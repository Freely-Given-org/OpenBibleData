            ...
            if versionAbbreviation not in ('Luth','ClVg'): # native or modernised English
                ...
                vPrint( 'Normal' if word.upper()==word
                       or word in ( #  \d{1,3}\), \(
                                ...
                                'unobedient','whoren','sharedn','goatsböcklein','saddenede',
                                'bodyrock','festivalus','outen','bodyrocks',
                                    ...
                                    'bedte','towache','killedst','flatr','outn',
                                ...
                                'announcent','subjoinsur','perpetuall',
                                'relibecauses','peacefuls','killur','inactivitym',
                                    ...
                                    'harmes','edant','petii','peto','petere','alti',
                                    'defectu','precedesur',
