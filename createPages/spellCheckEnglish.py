            ...
            if versionAbbreviation not in ('Luth','ClVg'): # native or modernised English
                ...
                vPrint( 'Normal' if word.upper()==word
                       or word in ( #  \d{1,3}\), \(
                                ...
                                'rede','kam','Korb','ward','Rat','Rede','messen','ging','Halle','und','ster','streng','tun','von','wer','zu','zwo',
                                'besäet','easilyfertig','difficultr','geuß','underwegen',
                                    'Yudäa','Philippus','Ischariot','Amithais','Yapho',
                                    'twelvete','rulertum','hundredundzwölf','contentiousn','eighttausend','fourte','thirteente','sixteente','seventeente','twentyste','oneste','twoste',
                                    'prayst','liftet','leavene','interestgroschen','paide','hightime','deceptivee','fewm','vomitedn','pottersacker',
                                    'erresearched','heartog',
                                ...
                                'l','nos','ut','didrachmas','cypri','dona',
                                'befores','believess','descendentes','periculo',
                                'whichro','plebi',
                                    ...
                                    'edgeus','occasio','resttionum','namedm','beforeparavi','outnde','inactivitym','asksur','exteriores','saddensi',
                                    'donkeym','rightsverit','beforeses',
                                    'tomorrowtinum','baptizo',
