        ...
        if word not in wordSet and f'{word[0].lower()}{word[1:]}' not in wordSet:
            ...
            if versionAbbreviation not in ('Luth','ClVg'): # native or modernised English
                ...
                vPrint( 'Normal' if word.upper()==word
                       or word in ( #  \d{1,3}\), \(
                                'an','aß','Bart','Bild','bis','bittern', 'Chor', 'sie','hin','heb','wir','dem','des','für','hub','ich','ist','ja','alle','las','lag','litt',
                                ...
                                'believese','servicee','officialsn','daywerk','almightyr','troff','pointse','upsteigen','beetwillen',
                                'umreißen','eingefaßte','stoneschneider',
                                    ...
                                    'leavene','paide','hightime','deceptivee','fewm','pointse','giftedn','steern',
                                    'maken','beargued','togangwärts','afterwardsmals','hinopened','afterzuyagen','winechläuche','warmen',
                                    'twoannual','erlernet','arklaus',
                                ...
                                'l','nos','ut','didrachmas','cypri','dona','befores','believess','descendentes','whichro','plebi','chosenon','yewels','blasphemare',
                                'nati','cavendum','parvum','acceptam','attendere',
                                    'res','knowti','boxnis','recordati','clange','reados','sectus','undis',
                                    'lovese','meum','weres','multiformis','professio','reprimandse','halfnt','stringit','foreignted','sendus',
                                    'occasio','resttionum','namedm','beforeparavi','outnde','asksur','saddensi','rightsverit','constitutione','successoribus','eagertatis',
                                    'pertransit','anathemate','themque','alveo','fightrent','anys','thinkes','habitndum',
                                    'beforeof','thatendum',
