...
def moderniseEnglishWords( html:str ) -> bool:
    ...
    for oldWords,newWord in ( # Place longer words first,
            ...
            ((' abideth',),' abides'), ((' aboute',),' about'), ((' accorde ',' acorde '),' accord '), ((' aftir',),' after'), ((' agayne','againe'),' again'),
                (('agaynst',),'against'),
                ((' alle ',' al '),' all '),(('Alle ',),'All '), ((' aloone',),' alone'),
                (('amased',),'amazed'), ((' amoge',),' among'),
                (('Andrewe',),'Andrew'), ((' aungel',),' angel'), (('answerede','answeride','aunswered'),'answered'), ((' ony ',),' any '),
                ((' appoynte','apoynte'),' appoint'),
                ((' aryse',),' arise'),
                (('astonnied',),'astonished'),
                ((' ete ',),' ate '), ((' athyrst',),' athirst'),
            ...
            (('baptysed','baptisid'),'baptised'), (('baptisynge',),'baptising'), (('baptisme','baptyme','baptym'),'baptism'), ((' baptyse',),' baptise'),
                ...
                ((' bi ',),' by '),
            ((' cam ',' camen '),' came '), (('Captaine',),'Captain'), ((' castynge',' castyng',' castinge'),' casting'),
                ((' certayne',' certein'),' certain'),
                (('chaunced','chaunsed'),'chanced'), (('chyldren',),'children'), (('chymney',),'chimney'), (('chirche',),'church'), (('Churche ',),'Church '),
                    (('Crist',),'Christ'),
                ((' cyte ',' citie '),' city '),
                ((' clouen',),' cloven'),
                ((' commeth','cometh'),' comes'), ((' comynge',),' coming'), (('contynued',),'continued'),(('contynuynge',),'continuing'), ((' coulde','coude'),' could'), ((' cuntree',' cuntrey',' cuntre',' cuntrei',' countrey',' countre'),' country'),
                ((' criede',),' cried'),
            ((' dayly',' daylie'),' daily'), ((' daies',' dayes'),' days'),((' daye ',),' day '),
                ...
                (('doctryne',),'doctrine'), ((' don ',),' done '), ((' dore',),' door'), ((' doue',),' dove'), ((' downe',),' down'), (('dwelleth',),'dwells'), (('dwellynge',),'dwelling'),
            ...
            ((' ech ',),' each '), ((' ete ',),' eat '),
                ...
                ((' euen ',),' even '), (('everlastinge','euerlastynge','euerlastyng','euerlastinge','euerlasting'),'everlasting'), ((' euer ',),' ever '),
            ((' fadir',),' father'), ((' feith','fayth'),' faith'),
                ((' feete',' fete'),' feet'), ((' felowe',),' fellow'), ((' feawe ',' fewe '),' few '),
                ((' fisscheris','fisshers','fysshers'),' fishers'), ((' fyue',' fyve',' fiue'),' five'),
                ((' flesshe',' fleshe',' fleische'),' flesh'),
                ...
                ((' fre ',),' free '),((' fre.',),' free.'), ((' freli',),' freely'), ((' freend',),' friend'),
            ...
            ((' lande ',' londe '),' land '),((' lande,',' londe,'),' land,'),((' lande.',' londe.'),' land.'), ((' laye ',),' lay '), ((' layed',' layde',' leiden'),' laid'),
                ...
                ((' lyfe',' lijf'),' life'), ((' lyght',' liyt'),' light'), ((' lyke',' lijk'),' like'), ((' litil',' lytell',' lytle',' litle'),' little'),
                ((' loynes',),' loins'), ((' lokide',' loked'),' looked'),
                    (('Lorde',),'Lord'),(('LORDE',),'LORD'), ((' louede',' loued',' louyde'),' loved'),
            ((' maad',),' made'), ((' makynge',),' making'), ((' maner',),' manner'), (('merveled',),'marvelled'), ((' maister',),' master'), ((' maye ',),' may '),
                ((' mendynge',' mendyng',' mendinge'),' mending'), ((' mesure',),' measure'),
            ...
            ((' parablis',),' parables'), ((' passide',),' passed'),
                ...
                (('praysed',),'praised'), (('preyeden',),'prayed'), (('preier',),'prayer'),
                    (('preche ',),'preach '), (('prechide',),'preached'), (('preachyng','prechynge','preachinge'),'preaching'),
            ...
            ((' sabat',' saboth'),' sabbath'), (('Saduceis','Saduces','Sadduces'),'Sadducees'), ((' saaf',),' safe'), ((' seiden',' seide',' sayde',' saide'),' said'), (('Sathanas','Sathan'),'Satan'), ((' saued',),' saved'), ((' sawe ',),' saw '),
                    ((' sayege',' sayinge'),' saying'), ((' seith ',),' says '),
                (('Scrybes',),'Scribes'), ((' scribis',' scrybes'),' scribes'),
                ((' se ',),' see '), ((' seyn ',' seene ',' sene '),' seen '), ((' silfe ',' silf ',' selfe '),' self '), ((' selues',),' selves'), ((' sente ',),' sent '),
                    ((' serue ',),' serve '), (('seruauntis','seruauntes','servauntes','seruauntes','seruants'),'servants'), ((' seuen ',' seue '),' seven '),
                ((' schal ',' shal '),' shall '), ((' shyppe',' shippe'),' ship'), ((' shoulde ',' shulde ',' shuld '),' should '),
                ...
                ((' summe ',),' some '), ((' sonnes',' sones'),' sons'), ((' sonne ',' sone '),' son '),((' sonne,',' sone,'),' son,'),  (('Sonne ',),'Son '),(('Sonne,',),'Son,'), ((' soiourne',),' sojourn'),
                ((' speake',),' speak'), ((' spirite',' sprete'),' spirit'),
                ((' styll',),' still'), ((' stoone',),' stone'), ((' stoupe',' stowpe'),' stoop'), (('stumbleth','stombleth','stomblith'),'stumbles'),
            ...
            ((' takun',),' taken'), ((' takynge',),' taking'),(('Takyng',),'Taking'), ((' tauyte',),' taught'),
                (('temptid',),'tempted'),
                ((' hem ',),' them '),((' hem.',),' them.'), ((' thanne ',),' then '), ((' thennus',),' thence'),
            ...
            (('Iames',),'Yames'),
                    ...
                    (('Iuda','Juda'),'Yudah'),  (('Iudea','Judee'),'Yudea'),
