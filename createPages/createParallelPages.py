...
'''
                        ...
                        try:
                            ...
                            if textHtml:
                                vHtml = f'''
    <p id="{versionAbbreviation}" class="parallelVerse"><span class="wrkName"><a title="View {state.BibleNames['OET']} chapter" href="{'../'*level}OET/byC/{BBB}_C{C}.htm#Top">OET</a> (<a title="View {state.BibleNames['OET-RV']} chapter" href="{'../'*level}OET-RV/byC/{BBB}_C{C}.htm#Top">OET-RV</a>)</span> {textHtml}</p>
    ''' if versionAbbreviation=='OET-RV' else f'''
    <p id="{versionAbbreviation}" class="parallelVerse"><span class="wrkName"><a title="View {state.BibleNames[versionAbbreviation]} chapter (translated from the Latin)" href="{'../'*level}{versionAbbreviation}/byC/{BBB}_C{C}.htm#Top">{versionAbbreviation}</a></span> {textHtml}</p>
    ''' if versionAbbreviation=='WYC' else f'''
...
ENGLISH_WORD_MAP = ( # Place longer words first,
    ...
    # Single words
    ((' abideth',),' abides'),((' abydinge',),' abiding'), ((' abyde ',),' abide '), ((' aboute',),' about'), ((' abstayne ',),' abstain '),
        ...
        (('Andrewe',),'Andrew'),
            ...
            (('anoyntiden','annoynted','anoynted'),'anointed'),(('Annoynted',),'Anointed'),((' annoynt',' anoynte',' anoynt'),' anoint'),
    ...
    ((' backe ',),' back '), (('baptysed','baptisid'),'baptised'), (('baptisynge','baptisyng'),'baptising'), (('baptisme','baptyme','baptym'),'baptism'), ((' baptyse',),' baptise'),
        ...
        ((' bee ',),' be '),
            ...
            ((' bene ',' ben '),' been '),
            ((' bifore',' bifor'),' before'),
            ((' beganne',' begane',' bigunnen',' bigan'),' began'), ((' bigat ',' begate '),' begat '), (('bigynnyng','beginnynge','begynnynge','begynnyng','begynninge'),'beginning'), (('bigetun ','begotte '),'begotten '),
            ...
            ((' berith',),' beareth'),
            (('besechyng','beseeching'),'beseeching/imploring'),(('biseche ','beseech '),'beseech/implore '),(('biseche,','beseech,'),'beseech/implore,'), ((' besydes',),' besides'),((' bisidis',),' beside'),
        ...
        ((' byd ',),' bid '), ((' byde ',),' bide/stay '), ((' bynde',),' bind'),
        ...
        (('buyldynges','buildynges','bildyngis'),'buildings'),(('buyldinge',),'building'),
            ...
            ((' busynesse',' busynes',' busines'),' business'),(('businesss',),'business'), ((' byers',' biggeris'),' buyers'),
        ((' bi ',),' by '),
    ...
    ((' ech ',),' each '),
            ((' eerli',' erly'),' early'), ((' eares ',' eeris ',' eris '),' ears '), ((' erthe',),' earth'),
        ...
        ((' ende ',),' end '), (('ynough','inough'),'enough'), ((' entred',' entriden',' entride',' entrid'),' entered'), ((' entre ',),' enter '),
    ...
    ((' failinge',),' failing'), ((' faynte ',' faynt '),' faint '), ((' feith',' fayth'),' faith'),
        ...
        ((' fielde',' feeld',' felde'),' field'), ((' feendis',),' fiends'),
            ...
            ((' fyue',' fyve',' fiue'),' five'),
        ((' flye ',' fle '),' flee '), ((' flesshe',' fleshe',' fleische',' fleisch'),' flesh'),
            ((' flyght ',),' flight '),
            (('flockis',),'flocks'), (('flowith ','floweth '),'floweth/flows '),
        ((' foale ',),' foal '), (('folowed','folewiden'),'followed'), ((' folowe',' folow'),' follow'), (('Folowe','Folow'),'Follow'),
            ((' foote ',' fote '),' foot '),
            (('forgeven','foryouun','forgeuen','forgiuen'),'forgiven'), ((' forgiue ',' foryyue ',' forgeve ',' forgeue '),' forgive '),
                ((' fornicacion',),' fornication'),
                ((' forsooke',' forsoke',),' forsook'),((' foorth',),' forth'),
    ...
    (('Galile ',),'Galilee '),(('Galile,',),'Galilee,'), ((' galoun',),' gallon'),
        ...
        ((' goost',),' ghost'),
        ((' yyueth',' geueth'),' giveth/gives'), (('Geue ','Giue '),'Give '),((' geve ',' geue ',' giue ',' yyue '),' give '),((' geve,',' geue,',' giue,',' yyue,'),' give,'),((' yyue?',' geue?',' geve?'),' give?'), ((' geven',' giuen',' geuen',' youun', ' youe'),' given'),
        ((' girdil',' gerdyll',' gerdell'),' girdle'),
        ((' gladde ',),' glad '), ((' glorie',),' glory'),
        (('Goo ',),'Go '),((' goe ',' goo '),' go '),((' goe.',' goo.'),' go.'),
            ((' goeth ',),' goeth/goes '),
    ...
    ((' hadden ',' hadde '),' had '),((' hadde;',),' had;'), ((' heeris',),' hairs'),
            ...
            ((' hardnesse ',' hardnes '),' hardness '),
            (('Haue ',),'Have '),((' haue ',),' have '), ((' hauynge',' havynge',' hauyng',' hauing'),' having'),
        ((' hee ',),' he '),
    ...
    ((' keperis',),' keepers'),((' keepe',' kepe'),' keep'), ((' keyes',' keies'),' keys'),
        ((' killiden',' kylled',' kyllid'),' killed'),
            ...
            ((' kiste ',' kyssed '),' kissed '),
        (('knewest','knewen','knewe'),'knew'), (('knowe',),'know'),(('Knowe',),'Know'), (('knowyng',),'knowing'),
    ((' lomb ',' lambe ',' labe '),' lamb '),(('Lambe',),'Lamb'), ((' lastynge',),' lasting'),
        ...
        (('learnyng','learninge','lernynge'),'learning'),((' learne ',' lerne '),' learn '),(('Learne ','Lerne '),'Learn '), ((' leest',),' least'), ((' leeues',' leaues',' leves'),' leaves'), ((' leeue ',' leaue ',' leue ',' leve '),' leave '),
            ((' ledde ',),' led '),
        ...
        (('lyberte','libertie'),'liberty'),
            ...
            ((' lyght',' liyt'),' light'),
            (('Lykewyse',),'Likewise'),(('lykewyse',),'likewise'), ((' lyke',' lijk'),' like'),
            ((' litil',' lytell',' lytle',' litle'),' little'),
            ((' liues',),' lives'),((' lyuynge',' lyuyng',' liuing',' livynge'),' living'),((' liue ',' lyue '),' live '),((' liue,',' lyue,'),' live,'),
    ...
    ((' maad',),' made'),
            ...
            ((' mariage',),' marriage'), (('marueyled','marueiled','merveled','marueled','merveyled','marveled'),'marvelled'), (('Maryes',),"Mary's/Maria's"),
        ...
        ((' mony',),' money'),
            (('Moreouer','Morouer'),'Moreover/What\'s_more'),(('morouer',),'moreover/what\'s_more'), ((' moare ',' mowe '),' more '), ((' morninge',' mornynge',' mornyng'),' morning'), ((' morowe',' morow'),' morrow'),
            (('Moises','Moyses'),'Moses'),
            ((' moder ',' modir '),' mother '),
            ((' mountayne',' mountaine'),' mountain'), ((' moute ',),' mount '), ((' mornen ',' mourne ',' morne '),' mourn '),((' mornen,',' mourne,',' morne,'),' mourn,'),((' mornen:',' mourne:',' morne:'),' mourn:'),
        ((' myche',' moche',' moch',' muche'),' much'), (('murthurers',),'murderers'),
    ((' naciouns',' nacions'),' nations'), ((' natiue',),' native'),
        ((' neere ',' neare '),' near '),((' neere.',' neare.'),' near.'),((' neere:',' neare:'),' near:'),
            ...
            ((' nether',' nethir'),' neither'),(('(nether',),'(neither'),
            ((' nettes',' nettis'),' nets'),
            (('Neuertheles ',),'Nevertheless '), ((' neuer',),' never'),
            ((' nexte',),' next'),
        ((' neer ',' nyer ',' nier '),' nigher/nearer '),((' nyy ',' nye '),' nigh/near '),((' nyy.',' nye.'),' nigh/near.'), ((' nyyti',),' night'),((' nyyt,',),' night,'), ((' nyenth',' nynthe',' nynth'),' ninth'),
    ...
    ((' obteyne ',' obteine '),' obtain '),
        ...
        ((' opynyouns',),' opinions'), ((' oppressith',),' oppresses'),
        (('Othir','Wother'),'Other'),((' othere ',),' other '),
        ((' oure ',),' our '),
            ((' outwarde',),' outward'), ((' oute.',),' out.'),
        ((' ouer',),' over'),
        ((' awne ',' owne '),' own '),
    ((' parablis',),' parables'), ((' partynge',),' parting'), ((' parts',' parties'),' parts/region'),
            (('Passeouer','Passouer'),'Passover'),((' passiden',' passide'),' passed'),((' passe ',),' pass '),((' passe?',),' pass?'),((' passe:',),' pass:'),
            ((' pacience',),' patience'),
            (('Pavl',),'Paul'),
            ((' paye ',),' pay '),
        ((' pees',),' peace'),
            ...
            (('perceiued','perceaved','perceaued'),'perceived'),(('Perceave','Perceiue'),'Perceive'),((' witen',),' perceive'), ((' perfaicte ',),' perfect '), (('persecucioun','persecucion'),'persecution'), ((' perische',' perisshe',' perishe'),' perish'), (('perteyneth',),'pertaineth/pertains'),(('pertayne ',),'pertain '),
            (('Petir',),'Peter'),
        ...
        (('playnely','playnly','plainely'),'plainly'), ((' playne ',' plaine '),' plain '),
            ...
            ((' plucke ',),' pluck '),
        ((' poore ',' povre ',' pore '),' poor '), (('possessyoun',),'possession'),(('possesse ',),'possess '), ((' powdir',),' powder'),
    ...
    (('Sabbathes',),'Sabbaths'),((' sabatys',),' sabbaths'),(('Sabboth','Saboth'),'Sabbath'),((' sabat',' saboth'),' sabbath'),
            ...
            ((' saaf',),' safe'),
            ((' seiden',' seide',' sayde',' sayd',' saide', ' seien'),' said'),
            ((' saltid',),' salted'),
        ...
        (('seesyde ' ,'seeside ',),'seaside '), ((' seet ',),' seat '),
            ...
            ((' seiy ',' se '),' see '), ((' seede ',' sede '),' seed '), ((' seken ',' seeke ',' seke '),' seek '), ((' semen ',' seeme ',' seme '),' seem '), ((' seyn ',' seene ',' sene '),' seen '),
        ...
        ((' schal ',' shal ',),' shall '),
            ...
            ((' shue',),' shoe'),((' schoo.',),' shoe.'), ((' shoore',),' shore'), (('shouldest','schulen'),'should'),((' schulden ',' schulde ',' shulde ',' shuld ',' shoulde '),' should '), (('shoute ','showte '),'shout '), (('schewide','shewed'),'showed'),((' schewe ',' shewe '),' show '),
        ...
        ((' slayn',' slaine'),' slain/killed'), (('sclaundrid',),'slandered/disgraced'), ((' sleepe',' slepe'),' sleep'), ((' slepith',),' sleeps'),
        ((' smale ',),' small '),
        (('Sodome ','zodom '),'Sodom '),
            ((' soiourne',),' sojourn'),
    ...
    (('tabernaclis',),'tabernacles/tents'),
        ...
        (('thankes','thakes'),'thanks'),(('thanke ',),'thank '), (('yt ','thilke '),'that '),
            ((' theyr ',),' their '),
            ...
            ((' thieues',' theeues',' theves'),' thieves'), ((' thyne ',' thine '),' thine/your '), ((' thinges',' thingis',' thynges'),' things'),((' thinge',' thyng'),' thing'), ((' thenkynge',),' thinking'), ((' thynke',' thenken'),' think'),
                ((' thridde',' thyrde',' thirde'),' third'), ((' thristen',),' thirsting'),((' thyrst ',' thurst ',' thirste '),' thirst '),
            (('thwong',),'thong'), ((' thou ',),' thou/you '), ((' thouy ',),' though '), (('thousynde','thousande'),'thousand'),
            ((' trone ',),' throne '), (('thorowout',),'throughout'), (('thorow ','thorou '),'through '),(('thorow,',),'through,'), (('throwen',),'thrown'),
        ...
        (('togidir','togidere','togidre','togedder'),'together'), ((' tokene ',),' token '), ((' tokun ',' toke ',' tooke '),' took '), ((' townes',' tounes'),' towns'),
        (('ttasfigured',),'transfigured'),
            (('treasurie','tresorie'),'treasury'), ((' tre,',),' tree,'),
            (('tribulacioun',),'tribulation'), ((' tryed',),' tried'),
            (('Treuli',),'Truly'),(('truely','treuli'),'truly'), (('sothfast',),'truthful'), ((' trueth',' treuthe',' verite'),' truth'),
    ...
    (('vnbileue','vnbelefe','vnbeleue','vnbeliefe'),'unbelief'),
        (('vncerteyn',),'uncertain'), (('vncleane','vnclene'),'unclean'), (('vncovered','vncouered'),'uncovered'),
            ((' vnderstande',' vnderstand'),' understand'),(('Vnderstonde',),'Understood'),((' vnderstonde',),' understood'), ((' vnder',),' under'),
    ...
    (('vanyte ','vanitie '),'vanity '),
        ((' verely',),' verily'),(('Ueryly','Verely'),'Verily'), ((' vessell',),' vessel'),
    ...
    (('walkynge','walkinge'),'walking'),((' walkid',),' walked'),((' walke ',),' walk '),((' walke,',),' walk,'),
             ...
             ((' watred',),' watered'),((' watris',),' waters'),((' watir',),' water'),
        ...
        (('Whatsoeuer',),'Whatsoever'),(('whatsoeuer',),'whatsoever'),
            ((' whanne ',' whan '),' when '), ((' whethir',),' whether'),
            (('Whiche ',),'Which '),((' whiche ',),' which '), ((' whill ',' whyle '),' while '),
        ...
        ((' womman',),' woman'), ((' wombe',),' womb'), ((' wymmen',' wemen'),' women'),
            ...
            ((' worde',),' word'), ((' worke ',' werk '),' work '),((' worke,',' werk,'),' work,'), ((' worlde',),' world'), ((' worme ',),' worm '), (('worschipide','worshypped'),'worshipped'), ((' worthie',' worthi'),' worthy'),
            (('Woulde ','Wolde '),'Would '),((' woldist ',' woldest ',' woulde ',' wolde '),' would '),
        ((' writyng',),' writing'),((' wryte ',),' write '), ((' wrytten',' writun'),' written'), ((' wroote ',' wroot '),' wrote '), (('wrouyt','wrought'),'wrought/done'),
