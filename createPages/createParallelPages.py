...
def moderniseEnglishWords( html:str ) -> bool:
    ...
    for oldWords,newWord in ( # Place longer words first,
            ...
            ((' abideth',),' abides'),((' abydinge',),' abiding'), ((' aboute',),' about'), ((' accorde ',' acorde '),' accord '), ((' aftir',),' after'),(('Aftir',),'After'), ((' agayne','againe'),' again'),
                ...
                (('Andrewe',),'Andrew'), ((' aungel',),' angel'), (('Anothir',),'Another'), (('answerede','answeride','aunswered'),'answered'),((' answere ',),' answer '), ((' ony ',),' any '),
            ...
            (('baptysed','baptisid'),'baptised'), (('baptisynge','baptisyng'),'baptising'), (('baptisme','baptyme','baptym'),'baptism'), ((' baptyse',),' baptise'),
                ...
                ((' bi ',),' by '),
            ((' clepide',' clepid'),' called'),((' cal ',),' call '), ((' cam ',' camen '),' came '), (('Captaine',),'Captain'), ((' castynge',' castyng',' castinge'),' casting'),
            ...
            ((' hadde ',),' had '), ((' heeris',),' hairs'), ((' handes',' hondes',' hoondis'),' hands'),((' hande',' honde',' hoond'),' hand'), ((' haue ',),' have '), ((' hauynge',' havynge','hauing'),' having'),
                ...
                (('honeste','honestye','honestie'),'honesty'), ((' hony',),' honey'), ((' houres',),' hours'), ((' housse ',' hous '),' house '),((' housse',),' house'),((' hous,',),' house,'), ((' hou ',' howe '),' how '),(('Hou ','Howe '),'How '),
            ...
            ((' lomb ',' lambe ',' labe '),' lamb '),(('Lambe',),'Lamb'), ((' lande ',' londe '),' land '),((' lande,',' londe,'),' land,'),((' lande.',' londe.'),' land.'), ((' laye ',),' lay '), ((' layed',' layde',' leiden'),' laid'),
                (('learnyng','learninge'),'learning'), ((' leften',' leeft',' lefte'),' left'), (('Leuite',),'Levite'),(('Leuite',),'Levite'),
            ...
            ((' sabat',' saboth'),' sabbath'), (('Saduceis','Saduces','Sadduces'),'Sadducees'), ((' saaf',),' safe'), ((' seiden',' seide',' sayde',' saide'),' said'), (('Sathanas','Sathan'),'Satan'),
                ...
                ((' se ',),' see '), ((' seyn ',' seene ',' sene '),' seen '), ((' silfe ',' silf ',' selfe '),' self '),((' silfe?',' silf?',' selfe?'),' self?'), ((' selues',),' selves'),
                    ((' senten ',' sente '),' sent '),
                    ((' serue ',),' serve '), (('seruauntis','seruauntes','servauntes','seruauntes','seruants'),'servants'),((' seruaunt',' servaunt'),' servant'), ((' seuen ',' seue '),' seven '),
                ((' schal ',' shal '),' shall '), ((' shyppe',' shippe'),' ship'), ((' shue',),' shoe'),((' schoo.',),' shoe.'), ((' shoulde ',' schulden ',' shulde ',' shuld '),' should '), ((' schewe',' shewe'),' show '),
            ...
            (('Ueryly','Verely'),'Verily'),
                ((' voyce',' vois'),' voice'),
            ((' walke ',),' walk '), ((' watir',),' water'), ((' watris',),' waters'),((' waye ',' weie '),' way '),
