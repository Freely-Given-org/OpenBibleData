...
ENGLISH_WORD_MAP = ( # Place longer words first,
    ...
    ((' abideth',),' abides'),((' abydinge',),' abiding'), ((' aboute',),' about'), ((' accorde ',' acorde '),' accord '), ((' aftir',),' after'),(('Aftir',),'After'), ((' agayne','againe'),' again'),
        (('agaynst',),'against'),
    ...
    (('baptysed','baptisid'),'baptised'), (('baptisynge','baptisyng'),'baptising'), (('baptisme','baptyme','baptym'),'baptism'), ((' baptyse',),' baptise'),
        ((' bee ',),' be '), ((' beastes','beestes','beestis'),' beasts'),((' beesti',),' beast'), ((' beed ',' bedde '),' bed '), ((' bene ',' ben '),' been '), ((' bifor',),' before'),
            ...
            (('behelde','biheeld'),'beheld'), ((' behinde',),' behind'),
        ...
        ((' bi ',),' by '),
    ((' clepide',' clepid'),' called'),((' cal ',),' call '), ((' cam ',' camen '),' came '),((' cam,',' camen,'),' came,'), (('Captaine',),'Captain'), ((' castynge',' castyng',' castinge'),' casting'),
        ...
        ((' cyte ',' citie '),' city '),
        ((' clouen',),' cloven'),
        ((' commeth','cometh'),' comes'), ((' comynge',' commyge',' comming'),' coming'), (('commaundement','comaundement','commandement'),'commandment'),
    ...
    ((' dayly',' daylie'),' daily'), ((' daies',' dayes'),' days'), ((' daye ',' daie ',' dai '),' day '),((' daye,',' daie,',' dai,'),' day,'),((' daye.',' daie.',' dai.'),' day.'),
        ((' deed',),' dead'), ((' deeth',' deth',' derth'),' death'), ((' delyte',),' delight'), ((' deliuered',),' delivered'),
    ...
    (('Galile ',),'Galilee '),(('Galile,',),'Galilee,'), ((' yaf ',' gaue '),' gave '), (('gadirid',),'gathered'),
        ((' goost',),' ghost'),
        ((' geve ',' geue ',' giue ',' yyue '),' give '), ((' geven',' giuen'),' given'),
    ...
    ((' hadde ',),' had '), ((' heeris',),' hairs'), ((' handes',' hondes',' hoondis'),' hands'),((' hande',' honde',' hoond'),' hand'), ((' haue ',),' have '), ((' hauynge',' havynge','hauing'),' having'),
        ((' hee ',),' he '), ((' hir ',),' her '),((' hir,',),' her,'),((' hir.',),' her.'), ((' hearde',' herden',' herde'),' heard'), ((' heareth',' herith'),' hears'), ((' hertis',' hertes',' heartes'),' hearts'), ((' heauens',' heuenes'),' heavens'), ((' heauen',),' heaven'),
        ...
        ((' holde ',),' hold '), (('honeste','honestye','honestie'),'honesty'), ((' hony',),' honey'), ((' houres',),' hours'), ((' housse ',' hous '),' house '),((' housse',),' house'),((' hous,',),' house,'), ((' hou ',' howe '),' how '),(('Hou ','Howe '),'How '),
    ...
    ((' keepe',' kepe'),' keep'),
        (('kingdome','kyngdoom','kyngdome'),'kingdom'), ((' kynges',' kyngis'),' kings'),((' kynge ',' kyng '),' king '), ((' kynnysmen',),' kinsmen'),
        (('knewe',),'knew'), (('knowe',),'know'), (('knowyng',),'knowing'),
    ((' lomb ',' lambe ',' labe '),' lamb '),(('Lambe',),'Lamb'), ((' lande ',' londe '),' land '),((' lande,',' londe,'),' land,'),((' lande.',' londe.'),' land.'), ((' laye ',),' lay '), ((' layed',' layde',' leiden'),' laid'),
        (('learnyng','learninge'),'learning'), ((' ledde ',),' led '), ((' leften',' leeft',' lefte'),' left'), (('Leuite',),'Levite'),(('Leuite',),'Levite'),
        ((' lyfe',' lijf'),' life'), ((' lyght',' liyt'),' light'), ((' lyke',' lijk'),' like'), ((' litil',' lytell',' lytle',' litle'),' little'), ((' lyuynge',' lyuyng',' liuing',' livynge'),' living'),
        ((' loynes',),' loins'), ((' longe ',),' long '), ((' lokide',' loked'),' looked'),
            ((' lordes',),' lords'),(('Lorde',),'Lord'),(('LORDE',),'LORD'),((' lorde ',),' lord '), ((' louede',' loued',' louyde'),' loved'), ((' loue ',),' love '),
    ((' maad',),' made'), ((' makynge',),' making'), ((' maner',),' manner'), (('merveled',),'marvelled'), ((' maister',),' master'),(('Maister',),'Master'), ((' maye ',),' may '),
    ...
    ((' parablis',),' parables'), ((' passide',),' passed'), ((' pacience',),' patience'),
        ...
        (('praysed',),'praised'), (('preyeden',),'prayed'), (('preier',),'prayer'),
            ...
            (('preestis','prestis','prestes','priestes'),'priests'),(('Priestes','Prestes'),'Priests'), (('princis',),'princes'),
    ...
    ((' sabat',' saboth'),' sabbath'), (('Saduceis','Saduces','Sadduces'),'Sadducees'), ((' saaf',),' safe'), ((' seiden',' seide',' sayde',' saide'),' said'), (('Sathanas','Sathan'),'Satan'),
        ...
        ((' sicke ',' sijk '),' sick '),((' sicke,',' sijk,'),' sick,'),((' sicke.',' sijk.'),' sick.'),
            ...
            (('Symon',),'Simon'),
            ((' sinnes',' synnes'),' sins'), ((' synne ',' sinne '),' sin '), ((' sistir',),' sister'), ((' syttyng',),' sitting'),
        ...
        ((' styll',),' still'), ((' stockis',),' stocks'), ((' stoone',),' stone'), ((' stoode ',' stode '),' stood '), ((' stoupe',' stowpe'),' stoop'),
    ...
    ((' takun',),' taken'), ((' takynge',),' taking'),(('Takyng',),'Taking'), ((' tauyte',),' taught'),
        (('techyng',),'teaching'),((' teache',' teche'),' teach'), (('temptid',),'tempted'), ((' tenthe',),' tenth'),
        ...
        ((' tyme',),' time'),
        (('togidir','togidere','togedder'),'together'), ((' toke ',),' took '),
        (('Treuli',),'Truly'),
        ((' turnede',),' turned'),
    ...
    (('Ueryly','Verely'),'Verily'),
        ((' voyce',' vois'),' voice'),
    (('walkynge','walkinge'),'walking'),((' walke ',),' walk '), ((' watir',),' water'), ((' watris',),' waters'),((' waye ',' weie '),' way '),
