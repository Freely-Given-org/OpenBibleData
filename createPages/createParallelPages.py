...
ENGLISH_WORD_MAP = ( # Place longer words first,
    ...
    ((' backe ',),' back '), (('baptysed','baptisid'),'baptised'), (('baptisynge','baptisyng'),'baptising'), (('baptisme','baptyme','baptym'),'baptism'), ((' baptyse',),' baptise'),
        ...
        ((' braunches',),' branches'),((' braunch',' braunche'),' branch'),
            (('britheren',),'brethren/brothers'),(('brithre.',),'brethren/brothers.'),(('brethren:','brethre:'),'brethren/brothers:'), ((' bryde',),' bride'), ((' bryngyng',),' bringing'),
    ...
    ((' clepide',' clepid'),' called'),((' cal ',),' call '),
        ...
        ((' coostis',' coastes'),' coasts'), ((' cootis',' coottes',' coates',' cotes'),' coats'),
            ...
            (('confessioun',),'confession'), (('congregacion',),'congregation'), (('consyderest','considerest'),'consider'), (('consolacion',),'consolation'), (('contynued',),'continued'),(('contynuynge',),'continuing'), (('conueniently','coueniently'),'conveniently'),
            ((' corne ',),' corn '),
    ...
    ((' ech ',),' each '),
        ...
        (('Euen ',),'Even '),((' euen ',),' even '), ((' euenyng',),' evening'),((' euentid ',),' eventide/evening '),
            (('everlastinge','euerlastynge','euerlastyng','euerlastinge','euerlasting'),'everlasting'), ((' eueremore',' euermore'),' evermore'), ((' euery',),' every'), ((' euer ',),' ever '),
        ((' yuelis',),' evils'),((' evyll',' euell',' euill',' euyll'),' evil'),
        (('excedyngly','exceadingly','exceedyngly'),'exceedingly'), ((' exercyse ',),' exercise '),
    ...
    (('Galile ',),'Galilee '),(('Galile,',),'Galilee,'), ((' galoun',),' gallon'),
        ...
        ((' goost',),' ghost'),
        ((' geve ',' geue ',' giue ',' yyue '),' give '),((' geve,',' geue,',' giue,',' yyue,'),' give,'),((' yyue?',),' give?'), ((' geven',' giuen',' geuen',' youun', ' youe'),' given'),
    ...
    ((' hadden ',' hadde '),' had '),((' hadde;',),' had;'), ((' heeris',),' hairs'),
        ...
        ((' hee ',),' he '),
            ...
            ((' hede ',' heede '),' heed '),
            ((' hir ',),' her '),((' hir,',),' her,'),((' hir.',),' her.'),((' hir;',),' her;'), (('hirdmen','hyrdmen','heardmen','herdmen'),'herdsmen'), (('Erodians',),'Herodians'),(('Herodes',),"Herod's"),(('Herode ','Eroude '),'Herod '), (('Eroude,',),'Herod,'),
        ...
        ((' holde ',),' hold '), ((' holynesse',' holynes'),' holiness'),((' holines ',),' holiness '),
            (('honeste','honestye','honestie'),'honesty'), ((' hony',),' honey'), ((' onoure',' onour'),' honour'),(('honoure,',),'honour,'), ((' houres',),' hours'), ((' housse ',' hous '),' house '),((' housse',),' house'),((' hous,',),' house,'), ((' hou ',' howe '),' how '),(('Hou ','Howe '),'How '),
        ((' hungren',),' hungering'),((' hungur',' honger'),' hunger'), (('husbande','hosebonde'),'husband'),
    (('Y ',),'I '),
    ...
    ((' keperis',),' keepers'),((' keepe',' kepe'),' keep'), ((' keyes',' keies'),' keys'),
        ((' kylled',),' killed'), (('kingdome','kyngdoom','kyngdome','kyngdom'),'kingdom'), ((' kynges',' kyngis'),' kings'),((' kynge ',' kyng '),' king '),((' kynge,',' kyng,'),' king,'),((' kynge.',' kyng.'),' king.'), ((' kynnysmen',),' kinsmen'), ((' kynne',),' kin'),
    ...
    ((' maad',),' made'), ((' makynge',),' making'),((' makere ',),' maker '),
            ...
            (('marueyled','marueiled','merveled','marueled','merveyled'),'marvelled'), (('Maryes',),"Mary's/Maria's"),
            (('Maister','Maistir'),'Master'),((' maister',),' master'),
            ((' mayest',' mayst'),' mayest/may'),((' maye ',),' may '),((' maye.',),' may.'),(('Maye ',),'May '),
        ((' `metis ',' metis '),' meats '),((' meate ',),' meat '),
            ((' meeke ',' meke '),' meek '),((' meeke:',' meke:'),' meek:'), ((' metinge',),' meeting'),((' meete ',' mete '),' meet '),((' meete,',' mete,'),' meet,'),((' meete:',' mete:'),' meet:'), (('meekenes','mekenes','meknes'),'meekness'),
        ...
        ((' mony',),' money'), (('Moreouer','Morouer'),'Moreover/What\'s_more'), ((' moare ',' mowe '),' more '), ((' moder ',' modir '),' mother '), ((' moute ',),' mount '), ((' mornen ',' mourne ',' morne '),' mourn '),((' mornen,',' mourne,',' morne,'),' mourn,'),((' mornen:',' mourne:',' morne:'),' mourn:'),
    ...
    ((' parablis',),' parables'), ((' parts',' parties'),' parts/region'),
            ...
            (('Pavl',),'Paul'),
            ((' paye ',),' pay '),
        ((' pees',),' peace'), (('penaunce',),'penance'),
            (('puplis',),'peoples'),((' puple',' pople'),' people'),
            (('perceiued','perceaved','perceaued'),'perceived'),(('Perceave','Perceiue'),'Perceive'),((' witen',),' perceive'), ((' perfaicte ',),' perfect '), ((' perische',' perisshe',' perishe'),' perish'),
            (('Petir',),'Peter'),
        (('Fariseis','Farisees','Pharises','pharisees'),'Pharisees'), (('Philippe',),'Philip'),
    ...
    (('Rabi',),'Rabbi'), ((' raysed',),' raised'),((' reise',),' raise'),
        ...
        ((' riche ',),' rich '), ((' ryght ',' riyt '),' right '), (('riytwisnesse ','rightewesnes ','righteousnes '),'righteousness '),(('riytwisnesse,','rightewesnes,','righteousnes,'),'righteousness,'),(('riytwisnesse:','rightewesnes:','righteousnes:'),'righteousness:'),((' ryghteous',),' righteous'), ((' ryse ',),' rise '),
        ((' rodde ',),' rod/staff '),((' rodde:',),' rod/staff:'),
            ((' roofe',' rofe'),' roof'), ((' roume',' rowme'),' room'), ((' roote',' rote'),' root'),
            ((' roos ',),' rose '),
        (('ruleth','rueleth'),'rules'), ((' rulars',),' rulers'),
    (('Sabbathes',),'Sabbaths'),((' sabatys',),' sabbaths'),(('Sabboth','Saboth'),'Sabbath'),((' sabat',' saboth'),' sabbath'), (('Saduceis','Saduces','Sadduces'),'Sadducees'), ((' saaf',),' safe'), ((' seiden',' seide',' sayde',' sayd',' saide', ' seien'),' said'),
            (('Sathanas','Sathan'),'Satan'), ((' satisfie ',),' satisfy '),
            ((' saued',),' saved'),((' saue ',),' save '),
            ((' sawe ',' sai '),' saw '),
            ((' seist',),' sayest'),((' sayege',' sayinge',' saynge'),' saying'), ((' seith ',' sayth '),' saith/says '), ((' seie ',' saye '),' say '),
    ...
    (('tabernaclis',),'tabernacles/tents'),
        ...
        (('thankes','thakes'),'thanks'),(('thanke ',),'thank '), (('yt ',),'that '),
            ((' theyr ',),' their '),
        ...
        (('treasurie','tresorie'),'treasury'), ((' tryed',),' tried'), (('Treuli',),'Truly'),(('truely',),'truly'), (('sothfast',),'truthful'), ((' trueth',' treuthe',' verite'),' truth'),
    ...
    (('vncerteyn',),'uncertain'), (('vncleane','vnclene'),'unclean'), (('vncovered','vncouered'),'uncovered'),
        ...
        ((' vp ',),' up '),((' vp,',),' up,'),((' vp.',),' up.'), ((' vpon ',' apon '),' upon '),(('Vpon ',),'Upon '), ((' vs',),' us'),
    ...
    (('walkynge','walkinge'),'walking'),((' walkid',),' walked'),((' walke ',),' walk '),((' walke,',),' walk,'),
        ...
        ((' wickid',),' wicked'),
            (('widewis','wyddowes','widowes'),'widows'),(('widewe ','wyddowe ','widdowe ','widowe '),'widow '), (('wyldernesse','wildirnesse','wyldernes','wildernesse'),'wilderness'), (('wildernes ',),'wilderness '),(('wildernes:',),'wilderness:'),
            ((' wyfe',' wijf'),' wife'),
