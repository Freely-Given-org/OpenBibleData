...
LAST_MODIFIED_DATE = '2023-07-08' # by RJH
...
ENGLISH_WORD_MAP = ( # Place longer words first,
    ...
    ((' backe ',),' back '), (('baptysed','baptisid'),'baptised'), (('baptisynge','baptisyng'),'baptising'), (('baptisme','baptyme','baptym'),'baptism'), ((' baptyse',),' baptise'),
            ...
            ((' batels',),' battles'),
        ((' bee ',),' be '), ((' bearinge',' beringe'),' bearing'),((' beare ',' bere '),' bear '), (('beastes','beestes','beestis'),'beasts'),((' beesti',),' beast'), ((' beed ',' bedde '),' bed '), ((' bene ',' ben '),' been '), ((' bifore',' bifor'),' before'),
    ...
    ((' clepide',' clepid'),' called'),((' cal ',),' call '),
        ...
        ((' citees',),' cities'),((' cyte ',' citie ',' citee '),' city '),((' citie,',' citee,',' cite,'),' city,'),
    ...
    ((' lomb ',' lambe ',' labe '),' lamb '),(('Lambe',),'Lamb'),
            ...
            ((' leeueful',' laufull',' lawfull'),' lawful'), ((' lawe ',),' law '),((' lawe,',),' law,'),
        ((' lyfte ',),' left '), (('learnyng','learninge','lernynge'),'learning'),((' learne ',' lerne '),' learn '),(('Learne ','Lerne '),'Learn '), ((' leeues',' leaues',' leves'),' leaves'), ((' leeue ',),' leave '),
            ((' ledde ',),' led '),
    ...
    (('Sabbathes',),'Sabbaths'),((' sabatys',),' sabbaths'),(('Sabboth','Saboth'),'Sabbath'),((' sabat',' saboth'),' sabbath'), (('Saduceis','Saduces','Sadduces'),'Sadducees'), ((' saaf',),' safe'), ((' seiden',' seide',' sayde',' sayd',' saide'),' said'),
        ...
        (('seeside',),'seaside'), ((' seet ',),' seat '),
            ...
            ((' sendith',' sendeth'),' sendeth/sends'),((' sende ',),' send '), ((' senten ',' sente '),' sent '),
    ...
    (('tabernaclis',),'tabernacles/tents'), ((' takun',),' taken'), ((' taried',),' tarried/waited'), ((' takynge',),' taking'),(('Takyng',),'Taking'), ((' tauyte',),' taught'),
        ...
        (('thankes','thakes'),'thanks'), ((' theyr ',),' their '),
            ((' hem ',),' them '),((' hem.',),' them.'), (('themselues',),'themselves'), (('Thanne ',),'Then '),((' thanne ',),' then '),((' thanne?',),' then?'), ((' thennus',),' thence'),
    ...
    (('walkynge','walkinge'),'walking'),((' walke ',),' walk '),
        ...
        ((' wickid',),' wicked'),
            ...
            ((' wi ',' wt '),' with '), (('widdred','wythred','wythered','wyddred'),'withered'),
