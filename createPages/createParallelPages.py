...
ENGLISH_WORD_MAP = ( # Place longer words first,
    ...
    ((' backe ',),' back '), (('baptysed','baptisid'),'baptised'), (('baptisynge','baptisyng'),'baptising'), (('baptisme','baptyme','baptym'),'baptism'), ((' baptyse',),' baptise'),
        ...
        ((' bee ',),' be '), ((' bearinge',' beringe',' berynge'),' bearing'),((' beare ',' bere '),' bear '), (('beastes','beestes','beestis'),'beasts'),((' beesti',),' beast'), ((' beed ',' bedde '),' bed '), ((' bene ',' ben '),' been '), ((' bifore',' bifor'),' before'),
            ...
            (('behelde','biheeld'),'beheld'), ((' behinde',' bihynde',' behynde'),' behind'), ((' biholdinge',),' beholding'),((' biholdist',' biholde'),' behold'), ((' bihoueth',),' behoves'),
    ...
    ((' hadden ',' hadde '),' had '),((' hadde;',),' had;'), ((' heeris',),' hairs'),
        ...
        ((' hee ',),' he '),
            ...
            ((' hede ',' heede '),' heed '),
            ((' hir ',),' her '),((' hir,',),' her,'),((' hir.',),' her.'),((' hir;',),' her;'), (('hirdmen','hyrdmen','heardmen','herdmen'),'herdsmen'), (('Erodians',),'Herodians'),(('Herodes',),"Herod's"),(('Herode ','Eroude '),'Herod '),
    ...
    ((' maad',),' made'), ((' makynge',),' making'),((' makere ',),' maker '),
        ...
        ((' mony',),' money'), (('Moreouer','Morouer'),'Moreover/What\'s_more'), ((' moder ',' modir '),' mother '), ((' moute ',),' mount '), ((' moare ',' mowe '),' more '),
    ...
    (('Sabbathes',),'Sabbaths'),((' sabatys',),' sabbaths'),(('Sabboth','Saboth'),'Sabbath'),((' sabat',' saboth'),' sabbath'), (('Saduceis','Saduces','Sadduces'),'Sadducees'), ((' saaf',),' safe'), ((' seiden',' seide',' sayde',' sayd',' saide', ' seien'),' said'),
        ...
        ((' schal ',' shal ',),' shall '),
            ...
            ((' shue',),' shoe'),((' schoo.',),' shoe.'), ((' shoore',),' shore'), (('shouldest','schulen'),'should'),((' schulden ',' schulde ',' shulde ',' shuld ',' shoulde '),' should '), (('schewide','shewed'),'showed'),((' schewe ',' shewe '),' show '),
        ...
        ((' slayn',' slaine'),' slain/killed'), (('sclaundrid',),'slandered/disgraced'), ((' slepe',),' sleep'), ((' slepith',),' sleeps'),
        ((' smale ',),' small '),
    ...
    (('Iames','James'),'Yames/Yacob'),
        ...
        (('Iohn','Ihon','Joon'),'Yohn'),
            ...
            (('Ioses','Joses'),'Yoses'),
        (('Iudas','Ivdas','Judas'),'Yudas'), (('Iuda','Juda'),'Yudah'), (('Iudea','Judee'),'Yudea'), (('Iude',),'Yude'),
