...
ENGLISH_WORD_MAP = ( # Place longer words first,
    ...
    ((' backe ',),' back '),((' backe,',),' back,'), (('baptysed','baptisid'),'baptised'), (('baptisynge','baptisyng'),'baptising'), (('baptisme','baptyme','baptym'),'baptism'), ((' baptyse',),' baptise'),
        ...
        (('Bee ',),'Be '),((' bee ',),' be '),(('>bee<',),'>be<'),((' bee<',),' be<'),
            ((' beerdes',),' beards'),((' bearde,',' beerde,'),' beard,'), ((' berith',),' beareth'), ((' bearinge',' bearynge',' beringe',' berynge'),' bearing'),((' beare ',' bere '),' bear '), (('beastes','beestes','beestis'),'beasts/animals'),((' beesti',' beeste',' beest'),' beast/animal'),
            ((' beed ',' bedde '),' bed '),
    ...
    ((' dayly',' daylie'),' daily'),
        ...
        ((' dekenes',),' deacons'), ((' deed',),' dead'), (('Deare ',),'Dear '),((' deare ',' dere '),' dear '), ((' deathes',),' deaths'),((' deeth',' deth',' derth'),' death'),
        ...
        ((' dyd ',' diden ',' dide '),' did '),((' dide,',),' did,'),
            ...
            ((' dychis',),' ditches'),
            ((' dyvers',' diuerse',' diuers'),' diverse/various'), (('devided','deuided','deuyded','diuided'),'divided'), (('devorsement','deuorcemet','diuorcement'),'divorcement'),
    ...
    (('Ech ',),'Each '),((' ech ',),' each '),
        ...
        ((' ende ',),' end '),((' ende,',),' end,'),
            ...
            ((' entred',' entriden',' entride',' entrid'),' entered'),((' entereth',' entreth'),' entereth/enters'),((' entring ',),' entering '),((' entre ',),' enter '),
        (('Hester',),'Esther'),
    ...
    ((' hadden ',' hadde '),' had '),((' hadde;',),' had;'),
        ...
        ((' holdeth',),' holdeth/holds'),((' hoolde ',' holde '),' hold '),
            ...
            ((' houres',),' hours'),((' houre ',),' hour '), ((' housis ',),' houses '),((' housse ',' hous ',' hows '),' house '),((' housse',),' house'),((' hous,',' hows,'),' house,'),((' hows.',),' house.'), (('houssholde','householde','housholde'),'household'),
    ...
    ((' keperis',),' keepers'),((' keepeth ',' kepith ',' kepeth '),' keepeth/keeps '),((' keepe ',' kepe '),' keep '),((' kepynge',),' keeping'),
        ...
        ((' killiden',' killide',' kylled',' kyllid'),' killed'),((' kyll ',),' kill '),((' kyll.',),' kill.'),
            ((' kindnes ',),' kindness '),((' kindnesse',),' kindness'), ((' kinrede',),' kindred'), ((' kyndes',' kindes'),' kinds'),((' kynde ',' kyn '),' kind '), (('kingdome','kyngdoom','kyngdome','kyngdom'),'kingdom'), ((' kynges',' kyngis',' kinges'),' kings'),((' kynge ',' kyng ',' kinge '),' king '),((' kynge,',' kyng,'),' king,'),((' kynge.',' kyng.'),' king.'), ((' kynysman',' kynesman',' kynsman'),' kinsman'),((' kynnysmen',),' kinsmen'), ((' kynne',),' kin'),((' kyn,',),' kin,'),
    ...
    ((' maad',),' made'),
        ...
        ((' mony',),' money'), ((' monethe',' moneth'),' month'),
            ...
            (('Mardochee','Mardocheus'),'Mordecai'),
                (('Moreover','Moreouer','Morouer'),'Moreover/What\'s_more'),(('moreouer','morouer'),'moreover/what\'s_more'), ((' moare ',' mowe '),' more '),
    ...
    ((' oke ',' ook '),' oak '), ((' othe ',' ooth '),' oath '),
        (('obeysaunce','obeysance'),'obeisance'),
            ((' obserued',),' observed'),
        ...
        ((' ouer ',),' over '), (('ouercommeth','ouercometh'),'overcometh/overcomes'), ((' ouercome',),' overcome'), ((' ouershadowed',),' overshadowed'), ((' ouerthrow ',),' overthrow '),((' ouerthrowen',),' overthrown'),
    ...
    (('Rabi',),'Rabbi'),
        ...
        ((' redi ',),' ready '),((' redi,',),' ready,'), ((' realme',' rewme'),' realm'), (('reasonyng','reasoninge'),'reasoning'),
            ...
            (('refrayne ',),'refrain '),
            (('regardest',),'regard'),
            ((' regnede',' raigned'),' reigned'),((' raygne',' regne',' raign'),' reign'),
    ...
    (('Sabbathes',),'Sabbaths'),((' sabatys',),' sabbaths'),(('Sabboth','Saboth'),'Sabbath'),((' sabat',' saboth'),' sabbath'),
        ...
        ((' sealeth',),' sealeth/seals'), (('seesyde ' ,'seeside ',),'seaside '), ((' seete ',' seet ',' seate '),' seat '),((' seate.',),' seat.'),
            ...
            ((' sendeth',' sendith'),' sendeth/sends'),((' sende ',),' send '), ((' senten ',' sente '),' sent '),((' sente,',),' sent,'),
            ((' sermoun',),' sermon'),
        ...
        ((' staffe ',),' staff '), (('stondinge','standyng','stodinge'),'standing'),((' stondith',),' standeth/stands'),((' stande ',' stonde '),' stand '),((' stonde.',),' stand.'), ((' starre',),' star'),  (('staciouns',),'stations'),
            (('stidfast',),'steadfast'),(('steade',),'stead'), ((' steale.',),' steal.'),
                ((' stele ',),' steel '),
                (('Steppe ',),'Step '),
        ...
        (('Swere ','Sweare '),'Swear '), (('swete ',),'sweet '), (('swiftere ','swyfter '),'swifter '), ((' sworde',' swerde',' swerd'),' sword'),
        (('synagoge',),'synagogue'),
    ...
    ((' wayte ',' waite '),' wait '),((' waite,',),' wait,'),((' waytinge',),' waiting'),
        ...
        (('Wee ',),'We '),((' wee ',),' we '),((' wee?',),' we?'),
            ...
            ((' weepe ',' wepe '),' weep '),((' weepe?',' wepe?'),' weep?'),((' wepith',),' weepeth/weeps'),((' wepyng',),' weeping'),
    ...
    (('Iaakob','Iacob'),'Yacob'), (('Iames','James'),'Yames/Yacob'), (('Iauan',),'Yavan'),
        (('Yee ','Ye '),'Ye/You_all '),((' ye ',' yee '),' ye/you_all '),((' ye,',' yee,'),' ye/you_all,'), ((' thi ',' thy '),' thy/your '), ((' youre ',),' your(pl) '),
