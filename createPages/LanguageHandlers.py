...
ENGLISH_WORD_MAP = ( # Place longer words first,
    ...
    ((' keperis',),' keepers'),((' keepeth ',' kepith ',' kepeth '),' keepeth/keeps '),((' keepe ',' kepe '),' keep '),((' kepynge',),' keeping'),
        ...
        ((' killiden',' killide',' kylled',' kyllid'),' killed'),((' kyll ',),' kill '),((' kyll.',),' kill.'),
            ((' kindnesse',),' kindness'), ((' kinrede',),' kindred'), ((' kyndes',' kindes'),' kinds'),((' kynde ',' kyn '),' kind '), (('kingdome','kyngdoom','kyngdome','kyngdom'),'kingdom'), ((' kynges',' kyngis',' kinges'),' kings'),((' kynge ',' kyng ',' kinge '),' king '),((' kynge,',' kyng,'),' king,'),((' kynge.',' kyng.'),' king.'), ((' kynysman',' kynesman',' kynsman'),' kinsman'),((' kynnysmen',),' kinsmen'), ((' kynne',),' kin'),((' kyn,',),' kin,'),
