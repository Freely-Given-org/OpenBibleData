...
LAST_MODIFIED_DATE = '2024-10-11' # by RJH
    ...
    ((' hadden ',' hadde '),' had '),((' hadde;',),' had;'),
        ...
        (('Hee ',),'He '),((' hee ',),' he '),
            ((' heades',' heddes',' heedis'),' heads'),((' heade ',),' head '),
                ...
                ((' heate',' heete'),' heat'), (('Heythen',),'Heathen'),((' hethene',),' heathen'),
    ...
    (('Rabi',),'Rabbi'), ((' raysed',),' raised'),((' reise',' reyse',' rayse'),' raise'), ((' reasinges ',' rasyns '),' raisins '),
        ...
        ((' redi ',),' ready '),((' redi,',),' ready,'), ((' realme',' rewme'),' realm'), (('reasonyng','reasoninge'),'reasoning'),
            ((' resseyueth',' receaveth',' receaueth',' receiueth'),' receives'),((' resseyueden',' resseyuede',' receaved',' receaued',' receiued'),' received'),((' resseyue',' receave',' receaue',' receiue'),' receive'),
                (('recompence',),'recompense'), ((' recorde ',),' record '), (('recouered',),'recovered'),(('recouering',),'recovering'),
    ...
    ((' wayte ',' waite '),' wait '),((' waite,',),' wait,'),((' waytinge',),' waiting'),
        ...
        (('Whatsoeuer',),'Whatsoever'),(('whatsoeuer',),'whatsoever'),
            ...
            (('Whiche ',),'Which '),((' whiche ',),' which '),
                ...
                (('whyte ','whijt '),'white '), (('withersoeuer',),'whithersoever'),
...
GERMAN_WORD_MAP = (
    ...
    ('Habe ','goods '), (' habe ',' have '),(' habe,',' have,'),(' habe.',' have.'),(' habe;',' have;'), ('haben','have'), (' habt',' have'),
        ...
        (' hebräisch ',' hebrew '),
            ('Heere ','armies '),
            ('Heiden ','heathens '), (' heilig',' holy'), (' heißt',' is_called'),
            ('heller ','brighter '),
            (' herab ',' down '),
    ...
    ('Wahrheit','truth'),
        ...
        (' wider ',' against '),
            ('Wie ','How '),('>wie ','>as '),(' wie ',' like '), (' wiederum',' again/in_turn'),(' wieder',' again'),
...
LATIN_WORD_MAP = (
    ...
    (' a ',' from '),
        ...
        ('Audita ','Hearing '),('Audi,','Listen,'),(' audi ',' listen '),(' audio',' I_hear'), (' audientes ',' hearing '), (' auribus ',' in_the_ears '), (' autem',' however'),
    ('Benedictus ','Blessed '),
    ...
    ('dæmonia','demons'), (' daret ',' would_give '),(' daretur',' would_be_given'),
        ...
        (' docebo ',' I_will_teach '), (' docet',' teaches'),
            (' dolor ',' pain '),
            ('Domini ','Master '),('Domini,','Master,'),('Domini.','Master.'),('domini ','master '),('Dominus','Master'), (' domum ',' home '), (' domus ',' home '),
        ('donec ','until '),
    ...
    (' faciam ',' I_will_do '),(' faciat ',' let_him_do '), (' faciem ',' face '), (' faciens ',' making '), (' facies',' faces'), (' facite ',' do_it '), (' facta ',' facts '), ('facultatibus','resources'),
        ...
        ('Fiat ','Let_it_happen '),
            ...
            (' fieri ',' to_be_done '),
            (' filia',' daughter'),('Filiæ','Daughters'),(' filiæ',' daughters'),('Filii','Children'),(' filii',' children'),('filiorum','of_children'),('Filium','Son'),(' filium ',' son '),('Filius','Son'),('Fili,','Son,'),(' fili ',' son '),
            (' finibus ',' borders '),
        ('fluctus ','wave '),
    ...
    (' occidas ',' kill '), (' ocreas ',' boots '),
        (' oleum ',' oil '),
        ('Omnes ','All_of_them '),(' omnes ',' everyone '), (' omni ',' all '), ('Omnia ','Everything '),(' omnia ',' everything '),(' omnia,',' everything,'), ('Omnis ','Everyone '),(' omnis ',' everyone '), (' omnipotens',' omnipotent'),
    ...
    (' qua ',' which '),(' quæ ',' which '),(' quambis ',' with_which '),
            ...
            (' quasi ',' as_if '), ('quæsierit','he_asked'),
            (' quatuor',' four'),
        (' quem ',' which '),
