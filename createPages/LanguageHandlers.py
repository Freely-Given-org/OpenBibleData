...
LATIN_WORD_MAP = (
    ...
    (' faciam ',' I_will_do '),(' faciat ',' let_him_do '), (' faciebat ',' he_was_doing '), (' faciem ',' face '), (' faciens ',' making '), (' facies',' faces'), (' facite ',' do_it '), (' facta ',' facts '), ('Factum ','Done '), ('facultatibus','resources'),
    ...
    (' radix ',' root '),
        (' rectas ',' correct '),
            (' regis',' king'),(' regnavit',' reigned'),(' regnum',' kingdom'),
            (' reliqui ',' I_left '),
