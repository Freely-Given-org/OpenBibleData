...
ENGLISH_WORD_MAP = ( # Place longer words first,
    ...
    (('Cæsar','Cesar'),'Caesar'),
        ...
        ((' coostis',' coastes'),' coasts'), ((' cootis',' coottes',' coates',' cotes'),' coats'),((' cote,',),' coat,'),
            ...
            ((' cometh',' commeth'),' cometh/comes'), ((' comest ',' commest '),' comest/come '),
                ...
                ((' confederacie ',),' confederacy '), ((' conforted',' coforted',' coumfortid'),' comforted'),((' coumfortour',),' comforter'), ((' coumforten ',' comforte '),' comfort '),
    ...
    ((' hadden ',' hadde '),' had '),((' hadde;',),' had;'),
        ...
        (('Hee ',),'He '),((' hee ',),' he '),
            ((' heades',' heddes',' heedis'),' heads'),((' heade ',),' head '),
                ...
                (('Heare ',),'Hear '), ((' hearde',' herden',),' heard'),((' herynge',' hearyng',' heryng',' hearinge',' heringe',' hering'),' hearing'),((' heareth',' herith'),' hears'),((' heare',' heere'),' hear'), (('Herken ',),'Hearken '), ((' hertis',' hertes',' heartes'),' hearts'),((' herte ',' hert '),' heart '),((' herte,',' hert,'),' heart,'),((' herte.',),' heart.'),
    ...
    (('tabernaclis',),'tabernacles/tents'),
        ...
        (('thankes','thakes'),'thanks'),(('thanke ',),'thank '), (('Thilke ',),'That '),((' thilke ',),' that '),
            ...
            (('thwong',),'thong'),
                ((' tho ',),' those '),
                ((' thou ',),' thou/you '),((' thou,',),' thou/you,'), ((' thouy ',),' though '), ((' thouytis ',' thoughtes '),' thoughts '),((' thouyte ',),' thought '),((' thoughte:',),' thought:'), (('thousynde','thousande'),'thousand'),
...
GERMAN_WORD_MAP = (
    ...
    ('Habe ','goods '), (' habe ',' have '),(' habe,',' have,'),(' habe.',' have.'),(' habe;',' have;'), ('haben','have'), (' habt',' have'),
            ...
            (' hat ',' has '),(' hat,',' has,'),(' hat.',' has.'),(' hat:',' has:'), (' hatte ',' had '),(' hatte.',' had.'),(' hatte;',' had;'),
        ...
        (' hebräisch ',' hebrew '),
            ...
            (' herab ',' down '),
                ...
                ('HErr','LORD'),('Herrn','Lord'),('Herr','Lord'), (' hervor',' out'), ('Herz','heart'),
...
LATIN_WORD_MAP = (
    ...
    ('Ibi ','There '),(' ibi ',' there '),
        ...
        (' irrue ',' rushed '),
        ('Israël','Israel'), (' iste ',' this '),(' istum',' that'),
    ...
    (' panis ',' bread '),
        ...
        ('præcepit','ordered'), ('prælium','battle'),
            ...
            ('procedens','proceeding'), ('procella ','storm '),
                ('propheta ','a_prophet '), ('proprie ','properly '), ('Propterea ',"That's_why "),
                (' proximo ',' the_next '),
        (' pueris ',' children '),
            (' pugna ',' fight '),
    ...
    ('Ubi ','Where '),(' ubi ',' where '),
        (' unctionis',' anointing'), (' unctus ',' anointed '),
            ...
            ('unigenitum','only_born'), (' unius',' of_one'), (' universus',' the_whole'),
            (' unum ',' one '),(' unum.',' one.'),
