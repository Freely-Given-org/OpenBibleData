...
ENGLISH_WORD_MAP = ( # Place longer words first,
    ...
    ((' failinge',),' failing'), ((' fayle ',),' fail '),
        ...
        ((' feare ',),' fear '), ((' feete',' fete'),' feet'), ((' felden ',' fel '),' fell '), ((' felowis',),' fellows'),((' felowe',),' fellow'), ((' feawe ',' fewe '),' few '),((' feawe.',' fewe.'),' few.'),
    ...
    ((' paynes',),' pains'),((' payne',),' pain'),
        ...
        (('playnely','playnly','plainely'),'plainly'), ((' playne ',' plaine '),' plain '),((' plaine,',),' plain,'), (('playe ',),'play '),(('plaier',),'player'),
    ...
    (('Rabi',),'Rabbi'), ((' raysed',),' raised'),((' reise',' reyse',' rayse'),' raise'), ((' reasinges ',' rasyns '),' raisins '),
        ...
        ((' rockes',),' rocks'),((' rocke ',),' rock '),((' rocke,',),' rock,'),
            ...
            ((' roofe',' rofe'),' roof'), ((' roume',' rowme',' roome'),' room'), ((' rootis',),' roots'),((' roote',' rote'),' root'),
            ((' roos ',),' rose '),((' roos,',),' rose,'),
            ((' rounde ',),' round '),
    ...
    (('Sabbathes',),'Sabbaths'),((' sabatys',),' sabbaths'),(('Sabboth','Saboth'),'Sabbath'),((' sabat',' saboth'),' sabbath'),
        ...
        ((' shadowe ',),' shadow '), (('Shal ',),'Shall '),((' schal ',' shal '),' shall '),((' schalt ',),' shalt '), ((' shappe ',),' shape '),
        ...
        ((' spette ',' spate '),' spat '),
            (('speakynge','spekynge','speakinge','spekinge','speakyng'),'speaking'),(('spekith ','speaketh '),'speaketh/speaks '),((' speake',),' speak'), ((' speares',),' spears'),((' speare ',),' spear '),((' speare,',),' spear,'),((' speare:',),' spear:'),((' spere;',),' spear;'),
...
GERMAN_WORD_MAP = (
    ...
    (' ehe ',' before '), (' ehernen ',' brazen '),
        (' eifriger',' more_eager'),
        (' eilete ',' rushed '), (' ein ',' a '),(' eine ',' one '),(' einem ',' one '),(' einen ',' a '),(' einen,',' a,'),(' einer,',' one,'),(' eines ',' one '), ('eingeborenen','native_born'),
        ('Engel','angel'),
        ('Erbe ','heritage '),
            ('Erde','earth'),
            (' erkannte',' recognised'),
    ...
    ('Ich ','I '),(' ich ',' I '),(' ich,',' I,'),(' ich.',' I.'),
        (' ihm ',' him '),(' ihm,',' him,'),(' ihm.',' him.'),(' ihm:',' him:'),(' ihm!',' him!'),
            (' ihn ',' him/it '),(' ihn,',' him/it,'), (' ihnen ',' to_them '),(' ihnen.',' to_them.'),(' ihnen:',' to_them:'),
...
LATIN_WORD_MAP = (
    ...
    ('Jordanem','Yordan'),
        (' juravit ',' he_promised '), (' justa.',' just.'),('Justi ','Just '), (' juxta ',' next_to '),
