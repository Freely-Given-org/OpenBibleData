...
ENGLISH_WORD_MAP = ( # Place longer words first,
    ...
    (('get bred',),'get bread'),
    (('hadden herd',),'had heard'), # 'herd' could be 'heard', but might be a 'herd'
    ...
    ((' backe ',),' back '), (('baptysed','baptisid'),'baptised'), (('baptisynge','baptisyng'),'baptising'), (('baptisme','baptyme','baptym'),'baptism'), ((' baptyse',),' baptise'),
        ...
        ((' braunches',),' branches'),((' braunch',' braunche'),' branch'), ((' brasse ',' bras '),' brass '),
            ((' breake ',),' break '), ((' brest ',),' breast/chest '), (('brethren','britheren',),'brethren/brothers'),(('brethre ',),'brethren/brothers '),(('brithre.',),'brethren/brothers.'),(('brethre:',),'brethren/brothers:'),
    ...
    (('Cæsar','Cesar'),'Caesar'),
        ...
        ((' coostis',' coastes'),' coasts'), ((' cootis',' coottes',' coates',' cotes'),' coats'),((' cote,',),' coat,'),
            ...
            (('Couenant',),'Covenant'),((' couenaunt',' couenaut',' couenant'),' covenant'), ((' couered',),' covered'), ((' couereth',),' covereth'), ((' couer ',),' cover '),
    ...
    ((' hadden ',' hadde '),' had '),((' hadde;',),' had;'),
        ...
        ((' hundrid',),' hundred'), ((' hungren',),' hungering'),((' hungride',' hungred',' hugred'),' hungered'),((' hungur',' honger'),' hunger'), ((' hurlide ',),' hurled '), ((' hurte ',),' hurt '), (('husbande','hosebonde'),'husband'),
    ...
    ((' labor',),' labour'), ((' ladde ',),' lad '), ((' lomb ',' lambe ',' labe '),' lamb '),(('Lambe',),'Lamb'), ((' lastynge',),' lasting'),
    ...
    (('quenchid','queched'),'quenched'), (('questioun',),'question'),
        (('quike',),'quick/alive'),
    (('Rabi',),'Rabbi'), ((' raysed',),' raised'),((' reise',' reyse',' rayse'),' raise'), ((' ranne ',),' ran '),
    ...
    (('Sabbathes',),'Sabbaths'),((' sabatys',),' sabbaths'),(('Sabboth','Saboth'),'Sabbath'),((' sabat',' saboth'),' sabbath'),
        ...
        (('swete ',),'sweet '), ((' sworde',' swerde',' swerd'),' sword'),
        (('synagoge',),'synagogue'),
    (('tabernaclis',),'tabernacles/tents'),
        ...
        (('thankes','thakes'),'thanks'),(('thanke ',),'thank '), (('Thilke ',),'That '),((' thilke ',),' that '),
            ...
            (('thwong',),'thong'), ((' thou ',),' thou/you '),((' thou,',),' thou/you,'), ((' thouy ',),' though '), ((' thouytis ',' thoughtes '),' thoughts '),((' thouyte ',),' thought '),((' thoughte:',),' thought:'), (('thousynde','thousande'),'thousand'),
...
GERMAN_WORD_MAP = (
    ...
    (' fahre ',' drive '), (' fast ',' nearly '),
        ...
        ('Fuß','foot'),
        ('Füßen ','feet '),('Füße ','feet '), (' führen',' lead'),(' führest',' lead'), (' fünf ',' five '), (' für ',' for '), (' fürchte ',' fear '),
...
LATIN_WORD_MAP = (
    ...
    (' faciam ',' I_will_do '),(' faciat ',' let_him_do '), (' faciem ',' face '), (' facite ',' do_it '), (' facta ',' facts '), ('facultatibus','resources'),
        ...
        ('Fiat ','Let_it_happen '),
            ...
            (' fieri ',' to_be_done '),
            (' filia',' daughter'),('Filiæ','Daughters'),('Filii','Children'),(' filii',' children'),('filiorum','of_children'),('Filium','Son'),('Filius','Son'),('Fili,','Son,'),(' fili ',' son '),
            (' finibus ',' borders '),
        ('fluctus ','wave '),
