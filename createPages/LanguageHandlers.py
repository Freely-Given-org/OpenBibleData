...
LAST_MODIFIED_DATE = '2024-10-14' # by RJH
...
ENGLISH_WORD_MAP = ( # Place longer words first,
    ...
    ((' hadden ',' hadde '),' had '),((' hadde;',),' had;'),
        ...
        ((' holdeth',),' holdeth/holds'),((' hoolde ',' holde '),' hold '),
            ...
            ((' houres',),' hours'),((' houre ',),' hour '), ((' housis ',),' houses '),((' housse ',' hous ',' hows '),' house '),((' housse',),' house'),((' hous,',' hows,'),' house,'), (('houssholde','householde','housholde'),'household'),
